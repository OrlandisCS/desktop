	...
	return (
		...
		(Fancy.namespace = function () {
			for (var a = 0, b = arguments.length; a < b; a++) {
				...
				for (var g = Fancy.global[d[0]]; e < f; e++)
					(g[d[e]] = g[d[e]] || {}), (g = g[d[e]]);
			}
		}),
		...
		(Fancy.each = function (a, b) {
			switch (Fancy.typeOf(a)) {
				...
				case 'string':
					...
					break;
				case 'object':
					for (var e in a) if (!0 === b(a[e], e, a)) break;
			}
		}),
		(Fancy.mixin = function (a, b) {
			...
			if ('object' === Fancy.typeOf(b[0]))
				for (; d < e; d++) {
					c = b[d];
					for (
						var f = c._class, g = c.methods, h = 0, i = g.length;
						h < i;
						h++
					) {
						var j = g[h];
				...
				for (; d < e; d++)
					if (((c = b[d]), Fancy.isString(c))) {
						var k = Fancy.ClassManager.getMixin(c);
						k
							? Fancy.apply(a, k.prototype)
							: Fancy.ClassManager.waitMixin(c, a);
		...
		(Fancy.Mixin = function (a, b) {
			...
			c.length > 1
				? ((f[c[c.length - 1]] = function () {}),
				  (f[c[c.length - 1]].prototype = b))
				: ((Fancy.global[c[0]] = function () {}),
				  (Fancy.global[c[0]].prototype = b));
			var g = Fancy.ClassManager.waitMixins[a];
			if (g)
				for (g = g.waiters, d = 0, e = g.length; d < e; d++)
					Fancy.apply(g[d], b);
		}),
		...
		Fancy.apply(Fancy, {
			...
			FIELD_SEARCH_PARAMED_EMPTY_CLS:
			...
			GRID_HEADER_CELL_TRIGGER_IMAGE_CLS:
				'fancy-grid-header-cell-trigger-image',
			GRID_HEADER_CELL_TRIGGER_DISABLED_CLS:
				'fancy-grid-header-cell-trigger-disabled',
			GRID_HEADER_CELL_GROUP_LEVEL_1_CLS:
			...
			GRID_HEADER_CELL_TRIGGER_UP_CLS:
				'fancy-grid-header-cell-trigger-up',
			GRID_HEADER_CELL_TRIGGER_DOWN_CLS:
				'fancy-grid-header-cell-trigger-down',
			GRID_HEADER_COLUMN_TRIGGERED_CLS:
				'fancy-grid-header-column-triggered',
			GRID_HEADER_CELL_FILTER_CLS: 'fancy-grid-header-filter-cell',
			GRID_HEADER_CELL_FILTER_FULL_CLS:
				'fancy-grid-header-filter-cell-full',
			GRID_HEADER_CELL_FILTER_SMALL_CLS:
				'fancy-grid-header-filter-cell-small',
			GRID_HEADER_CELL_CHECKBOX_CLS:
				'fancy-grid-header-cell-checkbox',
			GRID_HEADER_CELL_SORTABLE_CLS:
				'fancy-grid-header-cell-sortable',
			GRID_HEADER_CELL_NOT_SORTABLE_CLS:
				'fancy-grid-header-cell-not-sortable',
			GRID_HEADER_CELL_FILTERED_CLS:
				'fancy-grid-header-cell-filtered',
			GRID_SUB_HEADER_FILTER_CLS: 'fancy-grid-sub-header-filter',
			GRID_SUB_HEADER_FILTER_CONTAINER_CLS:
			...
			GRID_COLUMN_SPARKLINE_BULLET_CLS:
				'fancy-grid-column-sparkline-bullet',
			GRID_COLUMN_SPARK_PROGRESS_DONUT_CLS:
				'fancy-grid-column-spark-progress-donut',
			...
			PICKER_MONTH_ACTION_BUTTONS_CLS:
		...
		(function () {
			...
			11 ===
				...
				!1 === d && h && (d = !0),
				Fancy.apply(Fancy, { isOpera: c, isIE: d, isChrome: j }),
				(Fancy.getViewSize = function () {
					var a = [];
					return (
						Fancy.isIE
							? ((a[0] = document.documentElement.clientHeight),
							  (a[1] = document.documentElement.clientWidth))
				...
				(Fancy.getMouseWheelEventName = function () {
					return 'onmousewheel' in document.body
						? 'mousewheel'
						: 'DOMMouseScroll';
				}),
		...
		(Fancy.getModulesList = function () {
			var a = [];
			return (
				Fancy.each(Fancy.modules, function (b, c) {
					a.push(c);
				}),
				a
			);
		...
		(function () {
			...
			(Fancy.loadModule = function (b, c) {
				var d = document.getElementsByTagName('body')[0],
					...
					i =
						Fancy.MODULESDIR ||
						FancyGrid.MODULESDIR ||
						'https://cdn.fancygrid.com/@' +
							Fancy.version +
							'/modules/';
				(c = c || function () {}),
					!1 !== Fancy.MODULELOAD &&
				...
				(Fancy.loadStyle = function () {
					...
					if (
						...
						(f = f.replace('modules/', '')),
							...
							(c.href = f + 'fancy' + d),
							(c.rel = 'stylesheet'),
							(Fancy.loadingStyle = !0),
							(c.onload = function () {
								setTimeout(function () {
									(Fancy.loadingStyle = !1),
										(Fancy.stylesLoaded = !0);
								}, 100);
							}),
							b.appendChild(c);
					}
		...
		(Fancy.defineTheme = function (a, b) {
			var c = {};
			b.extend
				? (Fancy.apply(c, Fancy.getTheme(b.extend).config),
				  (c.extendedThemes = c.extendedThemes || []),
				  c.extendedThemes.push(b.extend))
				: 'default' !== a &&
				  Fancy.apply(c, Fancy.getTheme('default').config),
		...
		(Fancy.getThemeCSSCls = function (a) {
			...
			return (
				c &&
					c.config.extendedThemes &&
					Fancy.each(c.config.extendedThemes, function (a) {
						b += ' fancy-theme-' + a;
					}),
				b
			);
		...
		(Fancy.getTheme = function (a) {
			var b = { config: {} };
			return Fancy.isObject(a)
				? (Fancy.applyIf(b, Fancy.themes[a.name || 'default']),
				  Fancy.apply(
						b.config,
						Fancy.themes[a.name || 'default'].config
				  ),
		...
		(Fancy.String = {
			format: function (a) {
				...
				if ('array' === Fancy.typeOf(arguments[1])) b = arguments[1];
					...
					for (d = arguments.length, b = [], c = 1; c < d; c++)
						b[c - 1] = arguments[c];
		...
		(Fancy.Array = {
			...
			sum: function (a) {
				...
				if (Fancy.isArray(a[0]))
					for (d = []; b < c; b++)
						for (var e = 0, f = a[b].length; e < f; e++)
							void 0 === d[e] && (d[e] = 0), (d[e] += a[b][e]);
				else
					for (; b < c; b++)
						!1 !== Fancy.isNumber(a[b]) && (d += a[b]);
				return d;
			},
			min: function (a) {
		...
		(Fancy.Number = {
			...
			format: function (a, b, c) {
				var d, e;
				void 0 === b && (b = ','),
					Fancy.isNumber(b) && ((c = b), (b = ',')),
					(d = '' === b ? '.' : ',' === b ? '.' : ',');
				var f = a.toString().split('.');
				if (
					((f[0] = f[0].replace(/\B(?=(\d{3})+(?!\d))/g, b)),
					void 0 === f[1] && (f[1] = ''),
					void 0 !== c)
				)
					if (0 === c) e = f[0];
						...
						var g = c - f[1].length;
						if (g > 0) for (var h = 0; h < g; h++) f[1] += '0';
						else g < 0 && (f[1] = f[1].substring(0, c));
						e = f[0] + d + f[1];
					}
		...
		(Fancy.Collection = function (a) {
			...
			if (
				...
				else for (var e in a) b.add(e, a[e]);
		}),
		(Fancy.Collection.prototype = {
			...
			each: function (a) {
				for (var b = this, c = 0, d = b.length; c < d; c++)
		...
		(Fancy.Template.prototype = {
			...
			compile: function () {
				...
				return (
					eval(
						"me.compiled = function(values){ return '" +
							me.tpl.replace(me.re, fn) +
							"';};"
					),
					me
				);
		...
		(function () {
			...
			(d.prototype = {
				...
				waitMixin: function (a, b) {
					var c = this;
					(c.waitMixins[a] = c.waitMixins[a] || { waiters: [] }),
				...
				getMixin: function (a) {
					...
					for (; c < d; c++) if (void 0 === (e = e[b[c]])) return !1;
					return e;
				},
				has: function (b) {
					...
					if (Fancy.isArray(b)) {
						var c = !1;
						return (
							Fancy.each(b, function (a) {
								Fancy.ClassManager.get(a) && (c = !0);
							}),
							c
						);
					}
				...
				(Fancy.define = function (d, e) {
					...
					var f = [];
					if (
						(Fancy.ClassManager.has(d) &&
							Fancy.error('Overwritting class name ' + d),
						Fancy.isArray(d) && ((f = d), (d = f[0])),
						...
						switch (typeof e.extend) {
							case 'string':
								(g = Fancy.ClassManager.get(e.extend)),
									(a[d].prototype.$Super = Fancy.ClassManager.get(
										e.extend
									));
								break;
							case 'function':
						...
						delete e.extend,
							(a[d].prototype.Super = function (a, b) {
								...
								switch (
									(c.$Iam
										? (c.$Iam = Fancy.ClassManager.get(
												c.$Iam.prototype.$Super.prototype.$name
										  ))
										: (c.$Iam = Fancy.ClassManager.get(
												c.$Super.prototype.$name
										  )),
									a)
								) {
									case 'const':
					...
					(a[d].prototype.$name = d),
						e.mixins &&
							(Fancy.mixin(a[d].prototype, e.mixins),
							delete a[d].prototype.mixins),
						void 0 !== e.plugins &&
							(void 0 === a[d].prototype.$plugins &&
								(a[d].prototype.$plugins = []),
							(a[d].prototype.$plugins = a[
								d
							].prototype.$plugins.concat(e.plugins)),
							delete a[d].prototype.plugins);
					for (var h in e) a[d].prototype[h] = e[h];
					var i = a[d];
					!0 === e.singleton &&
						(delete a[d], (i = new i(e)), (a[d] = i)),
						f.length > 1
							? Fancy.each(f, function (a) {
									Fancy.ClassManager.add(a, i);
							  })
							: Fancy.ClassManager.add(d, i),
						e.type
							? ((b[e.type] = i), Fancy.addWidgetType(e.type, i))
							: e.ptype &&
							  ((b[e.type] = i), Fancy.addPluginByType(e.ptype, i));
				}),
		...
		(Fancy.MixinClass.prototype = {
			...
			initPlugins: function () {
				...
				if (
					...
					void 0 !== d.plugins &&
						((d.$plugins = d.plugins), delete d.plugins),
					void 0 !== d.$plugins)
				)
					for (
						var f, g = 0, h = d.$plugins, i = h.length, j = {};
						g < i;
						g++
					) {
						(c = h[g]), (c.widget = e);
						...
						if (!0 !== j[k]) {
							if (
								((j[k] = !0),
								void 0 === (a = Fancy.getPluginByType(k)))
							)
								throw new Error(
									'[FancyGrid Error] - some of module was not loaded. Grid plugin does not exist - ' +
										k
								);
							(b = new a(c)),
		...
		Fancy.define('Fancy.Data', {
			constructor: function (a) {
				var b = this;
				if (((b.map = {}), a))
					for (var c = 0, d = a.length, e = b.map; c < d; c++)
						e[c] = a[c];
				b.length = 0;
			},
			add: function (a, b) {
		...
		Fancy.define('Fancy.Model', {
			constructor: function (a) {
				...
				if (Fancy.isArray(a)) {
					...
					void 0 === c.id &&
						(Fancy.idSeed++, (c.id = Fancy.idSeed + 1e3)),
						(b.data = c),
						(b.id = b.data.id);
				} else {
					if (
			...
			Fancy.define(['Fancy.Event', 'Fancy.Observable'], {
				...
				constructor: function (a) {
					...
					if (
						...
						for (
							var c = b.listeners || b.events, d = 0, e = c.length;
							d < e;
							d++
						) {
							var f = c[d],
							...
							if (null === g)
								throw new Error(
									'[FancyGrid Error] - Event was not set'
								);
							switch (Fancy.typeOf(h)) {
								...
								default:
									throw new Error(
										'[FancyGrid Error] - Handler has wrong type or not defined'
									);
							}
							if (!1 === Fancy.isArray(k))
								throw new Error(
									'[FancyGrid Error] - params must be array'
								);
				...
				on: function (c, d, e, f, g) {
					if (void 0 === this.$events[c])
						throw new Error(
							'[FancyGrid Error] - Event name is not set: ' + c
						);
					if (void 0 === d)
						throw new Error(
							'[FancyGrid Error] - Handler is undefined. Name of event is ' +
								c +
								'.'
						);
					(d.$fancyFnSeed = a),
				...
				fire: function (a) {
					var b = this,
						c = b.$events[a];
					if (!c) return !1;
					for (var d = 1, e = arguments.length, f = [b]; d < e; d++)
						f.push(arguments[d]);
		...
		Fancy.Mixin('Fancy.store.mixin.Edit', {
			remove: function (a, b) {
				...
				if (f.isTree && !0 !== f.treeCollapsing) {
					var i = f.getById(h),
						j = f.getById(i.get('parentId'));
					if (!1 === i.get('leaf') && i.get('expanded')) {
					...
					j &&
						Fancy.each(j.data.child, function (a, b) {
							if (a.id === h) return j.data.child.splice(b, 1), !0;
						});
				}
				if (
					'server' === f.proxyType &&
					...
					return void (
						!1 !== b &&
						(!1 !== g.loadMask && g.showLoadMask(),
						f.proxyCRUD('DESTROY', h))
					);
				if (a.rowIndex)
					(c = f.dataViewIndexes[a.rowIndex]), (d = a.rowIndex);
				else if (
					((c = f.getDataIndex(h)),
					(d = f.getRow(h)),
					void 0 === c && void 0 === d)
				...
				if (f.isTree && f.treeCollapsing && f.filteredData) {
					...
					Fancy.each(f.data, function (a, b) {
						if (a.data.id === h) return (l = b), !0;
					}),
						(e = f.data.splice(l, 1)[0]);
				} else e = f.data.splice(c, 1)[0];
				f.paging && (d += f.showPage * f.pageSize),
					f.order && f.order.splice(d, 1),
					f.changeOrderIndexes && f.changeOrderIndexes(c),
					f.paging &&
						(0 !== f.showPage &&
							f.showPage * f.pageSize === f.getTotal() &&
							f.showPage--,
						f.calcPages()),
					delete f.map[h],
					f.treeCollapsing || !1 === b || f.fire('remove', h, e, c),
					!1 !== b && f.changeDataView();
			},
			removeAt: function (a) {
				var b = this;
			...
			removeAll: function () {
				...
				(a.data = []),
					(a.dataView = []),
					delete a.order,
					a.paging && ((a.showPage = 0), a.calcPages()),
					a.filters &&
						(delete a.filters,
						delete a.filteredData,
						delete a.filterOrder);
			},
			add: function (a) {
				var b = this;
			...
			insert: function (a, b, c) {
				var d = this;
				if (
					(Fancy.each(d.fields, function (a) {
						void 0 === b[a] && (b[a] = '');
					}),
					d.grouping &&
						!d.bugFixGrouping &&
						(d.defineModel(b, !0), (d.bugFixGrouping = !0)),
					(d.addIndex = a),
					void 0 === b.id)
				) {
					Fancy.idSeed++;
				...
				if (
					(d.getById(b.id) && d.remove(b.id, c),
					d.widget.isGroupable() &&
					...
					return d.insertItem(b, a, c);
				!1 !== c &&
					(d.once('create', d.onCreate, d), d.proxyCRUD('CREATE', b));
			},
			insertItem: function (a, b, c) {
				...
				return (
					(b = d.addIndex),
					d.treeExpanding || !1 === c || d.fire('beforeinsert'),
					delete d.addIndex,
					d.data.splice(b, 0, f),
					d.order &&
						(d.order.splice(b, 0, b),
						d.changeOrderIndexes(b, '+'),
						d.order[b]--),
					!1 !== c && d.changeDataView(),
					(d.map[a.id] = f),
					d.treeExpanding || !1 === c || d.fire('insert', f),
					f
				);
			},
		...
		Fancy.Mixin('Fancy.store.mixin.Dirty', {
			...
			onDirtySet: function (a, b) {
				...
				if ('$selected' !== b.key) {
					if (
						(void 0 === c.changed[d]
							? ((c.changed[d] = { length: 1 }), c.changed.length++)
							: c.changed[d].length++,
						void 0 === c.changed[d][b.key] &&
							(c.changed[d][b.key] = { originValue: b.oldValue }),
						(c.changed[d][b.key].value = b.value),
						c.changed[d][b.key].value ===
							c.changed[d][b.key].originValue)
					) {
						delete c.changed[d][b.key], c.changed[d].length--;
						for (
							var e = 0, f = c.undoActions.length - 1;
							e <= f;
							e++
						) {
							var g = f - e,
					...
					0 === c.changed[d].length &&
						(delete c.changed[d], c.changed.length--);
				}
			},
			...
			isDirty: function () {
				var a = this,
					b = !1;
				return (
					a.changed.length && (b = !0),
					a.removed.length && (b = !0),
					a.inserted.length && (b = !0),
					b
				);
			},
		}),
		Fancy.define('Fancy.Store', {
			...
			constructor: function () {
				...
				a.Super('const', arguments),
					...
					a.data &&
						(a.data.proxy
							? a.initProxy()
							: a.widget.isTreeData || a.setData(a.data)),
					a.readSmartIndexes(),
					a.widget.isGroupable() && a.orderDataByGroup(),
					a.widget.isTreeData && a.initTreeData();
			},
			init: function () {
				var a = this;
				a.addEvents(
			...
			setModel: function () {
				...
				if (
					((b =
						void 0 === b
							? Fancy.Model
							: Fancy.ClassManager.get(a.model)),
					(a.model = b),
					(a.fields = b.prototype.fields),
					void 0 === a.fields)
				)
					throw new Error(
						'[FancyGrid Error] - needed to set fields in Model of Store'
					);
			},
			setData: function (a) {
				var b,
				...
				if (
					...
					for (; d < e; d++)
						(b = new f(a[d])), (c.data[d] = b), (c.map[b.id] = b);
				else if (c.expanded)
					for (; d < e; d++)
						(b = new f(a[d])), (c.data[d] = b), (c.map[b.id] = b);
				else if (c.paging)
					...
					for (; d < e; d++)
						(b = new f(a[d])),
							...
							(c.map[b.id] = b);
				c.isTree &&
					Fancy.each(c.data, function (a) {
						a.get('expanded') &&
							Fancy.each(a.data.child, function (b, d) {
			...
			get: function (a, b, c) {
				...
				return f
					? void 0 === b
						...
						: c
						? ((f = e.data[a]),
						  'id' === b ? f.data[b] || f.id : f.data[b])
						: ((f = e.dataView[a]),
						  'id' === b ? f.data[b] || f.id : f.data[b])
					: ((f = e.order ? e.data[e.order[a]] : e.data[a]),
					  f ? ('id' === b ? f.data[b] || f.id : f.data[b]) : f);
			},
			getId: function (a) {
			...
			set: function (a, b, c, d) {
				...
				if (!Number.isNaN(c)) {
					if (
						(f.infiniteScrolledToRow && (h = f.infiniteScrolledToRow),
						a + h === -1
							? (e = f.getById(d))
							: ((e = f.dataView[a + h]), (d = e.data.id || e.id)),
						f._stopSaving ||
							g.fire('beforesaving', {
								rowIndex: a,
								key: b,
			...
			_set: function (a, b, c, d) {
				var e,
					...
					h = 0;
				if (
					(g.infiniteScrolledToRow && (h = g.infiniteScrolledToRow),
					a + h === -1
						? (e = g.getById(d))
						: ((e = g.dataView[a + h]), (d = e.data.id || e.id)),
					void 0 === c)
				) {
					var i = b;
					for (var j in i)
						if ('id' !== j) {
							var k;
							a + h === -1
								? ((f = e.get(j)), e.set(j, i[j]), (k = e.data))
								: ((f = g.get(a + h, j)),
								  (g.dataView[a + h].data[j] = i[j]),
								  (k = g.dataView[a + h].data)),
								g.fire('set', {
									id: d,
									data: k,
									rowIndex: a,
									infiniteRowIndex: a + h,
									key: j,
									value: i[j],
									oldValue: f,
									item: e,
				...
				if ((f = a + h === -1 ? e.get(b) : g.get(a + h, b)) != c) {
					...
					'server' === g.proxyType &&
						g.autoSave &&
						g.proxyCRUD('UPDATE', d, b, c);
					var k;
					(k = -1 === a ? e.data : g.dataView[a + h].data),
						g.fire('set', {
							id: d,
							data: k,
							rowIndex: a,
			...
			setItemData: function (a, b) {
				var c = this,
					d = c.get(a);
				if (
					(c.infinite && (a -= c.infiniteScrolledToRow),
					c.writeAllFields && 'server' === c.proxyType)
				)
					c.set(a, b);
				else for (var e in b) d[e] != b[e] && c.set(a, e, b[e]);
			},
			getLength: function () {
				var a = this,
					b = a.dataView.length;
			...
			getTotal: function () {
				var a = this;
				return 'server' === a.pageType
					? a.totalCount
					: a.filteredData
					? a.filteredData.length
					: void 0 === a.data
					? 0
					: Fancy.isObject(a.data)
					? 0
					: a.data.length;
			},
			defineModel: function (a, b) {
				...
				if (!c.model || !c.fields || 0 === c.fields.length || b) {
					...
					Fancy.define(f, { extend: Fancy.Model, fields: e }),
						(c.model = f),
						(c.fields = e),
						c.setModel();
				}
			...
			getFieldsFromData: function (a) {
				...
				if (!b)
					throw new Error(
						'[FancyGrid Error] - not set fields of data'
					);
				var c = b[0],
					d = [];
				void 0 === b.length && (c = b);
			...
			getColumnOriginalValues: function (a, b) {
				var c,
					...
					f = [],
					b = b || {},
					g = b.dataProperty || 'data',
					h = d[g],
					i = h.length;
				if ((/\./.test(a) && (c = !0), b.smartIndexFn))
					if (d.infinite)
						for (; e < i; e++)
							f.push(
								b.smartIndexFn(h[e + d.infiniteScrolledToRow].data)
							);
					else for (; e < i; e++) f.push(b.smartIndexFn(h[e].data));
				else if (b.format)
					if ('date' === b.type)
						for (; e < i; e++) {
							var j = h[e].data[a];
							null === j || '' === j
								...
								: f.push(Fancy.Date.parse(j, b.format, b.mode));
						}
					else if (c)
						for (; e < i; e++)
							f.push(this.getNestedValue(h[e].data, a));
					else for (; e < i; e++) f.push(h[e].data[a]);
				else if (b.groupMap)
					if (((d.groupMap = {}), c))
						for (; e < i; e++) {
							var k = h[e],
								j = this.getNestedValue(k.data, a);
					...
					for (; e < i; e++)
						f.push(this.getNestedValue(h[e].data || h[e], a));
				else
					for (; e < i; e++) {
						var l = h[e].data || h[e];
						f.push(l[a]);
			...
			getNestedValue: function (a, b) {
				var c = b.split('.');
				return c.length > 1
					? this.getNestedValue(a[c.shift(0, 1)], c.join('.'))
					: a[b];
			},
			changeDataView: function (a) {
				...
				(c.dataViewIndexes = {}),
					...
					c.paging &&
						((f =
							'server' === c.pageType ? 0 : c.showPage * c.pageSize),
						(g = f + c.pageSize));
				var k = c.getTotal();
				...
				if (c.order)
					if (c.grouping)
						for (b = c.grouping.by; f < g; f++)
							!0 === h
								? ((c.dataViewIndexes[d.length] = c.filterOrder[f]),
								  (l = j[f]))
								: ((c.dataViewIndexes[d.length] = c.order[f]),
								  (l = j[c.order[f]])),
								c.expanded[l.data[b]] &&
									(d.push(l), (e[l.id] = d.length - 1));
					else
						for (; f < g; f++)
							!0 === h
								? ((c.dataViewIndexes[d.length] = c.filterOrder[f]),
			...
			getColumnData: function (a, b) {
				var c = this,
					...
					e = c.data.length,
					f = [];
				if (b) for (; d < e; d++) f.push(b(c.data[d].data));
				else for (; d < e; d++) f.push(c.data[d].data[a]);
				return f;
			},
			getColumnUniqueData: function (a) {
				for (
					var b = this, c = 0, d = b.data.length, e = [], f = {};
					c < d;
					c++
				) {
					var g = b.data[c].data[a];
					!0 !== f[g] && ((f[g] = !0), e.push(g));
				}
				return (e = e.sort());
			},
			getData: function () {
				for (
					var a = this, b = 0, c = a.data.length, d = [];
					b < c;
					b++
				)
			...
			getDataView: function () {
				for (
					var a = this, b = 0, c = a.dataView.length, d = [];
					b < c;
					b++
				)
			...
			find: function (a, b, c) {
				var d,
					...
					i = [];
				if (c)
					for (h = e.data.length; g < h; g++)
						(d = e.order ? e.data[e.order[g]] : e.data[g]),
							d.data[a] === b && i.push(g);
				else
			...
			findItem: function (a, b) {
				for (
					var c, d = this, e = d.data, f = 0, g = e.length, h = [];
					f < g;
					f++
				)
			...
			getDataIndex: function (a) {
				for (
					var b, c, d = this, e = d.data, f = 0, g = e.length;
					f < g;
					f++
				)
			...
			each: function (a, b) {
				var c = this,
					...
					e = 0,
					f = d.length;
				if (b) for (; e < f; e++) a.apply(this, [d[e]]);
				else for (; e < f; e++) a(d[e]);
			},
			...
			addField: function (a) {
				var b = this,
					...
					d = !1;
				if (Fancy.isArray(a))
					return void Fancy.Array.each(a, function (a) {
						b.addField(a);
					});
		...
		(Fancy.Element.prototype = {
			...
			animate: function (a, b, c, d) {
				var e = {},
					f = !1,
					g = a.force;
				Fancy.nojQuery || ((f = !0), (g = !0)),
					Fancy.isObject(a) && delete a.force;
				for (var h in a) {
					var i = a[h];
					Fancy.isString(i) && (i = Number(i.replace('px', '')));
					var j = this.css(h);
					Fancy.isString(j) && (j = Number(j.replace('px', ''))),
						i !== j && ((e[h] = a[h]), (f = !0));
				}
				!1 !== f &&
					(g ? this.$dom.animate(e, b, c, d) : this.$dom.css(e));
			},
			index: function () {
							...
							var i = a.targetTouches[0],
								...
								k = Fancy.get(
									document.elementFromPoint(
										j[0] - document.body.scrollLeft,
										j[1] - document.body.scrollTop
									)
								),
								l = !1,
								m = 10,
							...
							for (var o = [], p = 0; m > 0 && n.dom; ) {
								...
								if (0 !== q.length) {
									...
									r &&
										...
										void 0 === e.touchInDelegate[d]
											? (e.touchInDelegate[d] = r)
											: e.touchInDelegate[d] !== r &&
											  (e.touchInDelegate[d] = [
													e.touchInDelegate[d],
													r,
			...
			onTouchLeaveEvent: function (a, b, c, d) {
				...
				if (Fancy.isTouch) {
					var h = function (a, c) {
						...
						if (
							(g.length > 30 &&
								(g = g.slice(g.length - 5, g.length - 1)),
							g.push(k.dom),
							d && e.touchInDelegate[d])
						) {
							var o,
								p = Fancy.id();
							(o = Fancy.isArray(e.touchInDelegate[d])
								? Fancy.get(e.touchInDelegate[d][0])
								: Fancy.get(e.touchInDelegate[d])),
								o.attr(h, p),
								(m = 10);
							var q = !1;
							for (n = k; m > 0 && n.dom; ) {
			...
			getDelegateTarget: function (a, b, c, d) {
				for (
					var e = c[d - a.match(/\./g).length], f = 0, g = b.length;
					f < g;
					f++
				)
			...
			onTouchMove: function (a, b, c) {
				...
				if (Fancy.isTouch) {
					var f = function (a, c) {
						...
						for (
							var g = a.targetTouches[0],
								h = [g.pageX, g.pageY],
								i = !1,
								j = 10,
								k = Fancy.get(
									document.elementFromPoint(
										h[0] - document.body.scrollLeft,
										h[1] - document.body.scrollTop
									)
								),
								l = k;
							j > 0 && l.dom;
						...
						d.removeAttr(f),
							i &&
								((a.pageX = g.pageX), (a.pageY = g.pageY), b(a, c));
					};
					e.on('touchmove', f);
				}
			},
		...
		(Fancy.Elements.prototype = {
			attr: function (a, b) {
				var c = this,
					d = c.$dom;
				return (
					c.length > 1 && (d = c.$dom[0]),
					void 0 === b ? d.attr(a) : d.attr(a, b)
				);
			},
			addClass: function (a) {
				this.addCls.apply(this, arguments);
			...
			finish: function () {
				for (var a = this, b = 0, c = a.length; b < c; b++)
					Fancy.get(a.$dom[b]).finish();
			},
			addCls: function (a) {
				for (var b = this, c = 0, d = b.length; c < d; c++)
			...
			each: function (a) {
				for (var b, c = this, d = 0, e = c.length; d < e; d++)
					(b = new Fancy.Element(c.$dom[d])), a(b, d);
			},
			last: function () {
				var a = this;
		...
		(Fancy.Ajax = function (a) {
			...
			a.url && (b.url = a.url),
				...
				a.dataType && (b.dataType = a.dataType),
				a.sendJSON &&
					((b.dataType = 'json'),
		...
		(function () {
			...
			b.define('Fancy.Button', {
				...
				constructor: function (b, c) {
					var d = this;
					b.toggleGroup &&
						((a[b.toggleGroup] = a[b.toggleGroup] || {
							active: !1,
							items: [],
						}),
						a[b.toggleGroup].items.push(d)),
						(d.scope = c || b.scope || d.scope || d),
				...
				tpl: [
					'<div class="' + h + '"></div>',
					'<a class="' + j + '">{text}</a>',
					'<div class="' + k + '" style="{dropDisplay}"></div>',
				],
				render: function () {
					var a,
						c = this,
					...
					switch (
						(c.theme &&
							Fancy.themes[c.theme] &&
							(g = Fancy.themes[c.theme].config.charWidth),
						c.i18n)
					) {
						case 'zh-CN':
						case 'zh-TW':
					...
					if (
						(c.fire('beforerender'),
						c.wrapper && c.renderWrapper(),
						(a = b.get(c.renderTo || document.body).dom),
						c.width
							? (e = c.width)
							: !1 !== c.text &&
							  void 0 !== c.text &&
							  (e += c.text.length * g + 2 * g),
						c.imageColor && (c.imageCls = i),
						e < c.minWidth &&
							(e = (c.text && c.text.length, c.minWidth)),
						c.imageCls && c.text && (e += c.imageWidth),
						c.menu && (e += c.rightImageWidth),
						d.addCls(b.cls, c.widgetCls, c.cls, c.extraCls),
						c.disabled && d.addCls(f),
						c.menu && !1 !== c.menuIcon && d.addCls(l),
						d.css({ width: e + 'px', height: c.height + 'px' }),
						c.hidden && d.css('display', 'none'),
						d.css(c.style || {}),
						d.update(c.tpl.getHTML({ text: c.text || '' })),
						c.imageCls)
					) {
						var j = d.select('.' + h);
						c.imageColor && j.css('background-color', c.imageColor),
							j.css('display', 'block'),
							b.isString(c.imageCls) && j.addCls(c.imageCls);
					}
					c.id && d.attr('id', c.id),
						(c.el = b.get(a.appendChild(d.dom))),
						c.disabled && c.disable(),
						c.pressed && c.setPressed(c.pressed),
						c.initToggle(),
						(c.width = e),
						c.fire('afterrender'),
						c.fire('render');
				...
				renderWrapper: function () {
					...
					e.css(c.style || {}),
						e.addCls(c.cls || ''),
						(a.wrapper = b.get(d.appendChild(e.dom))),
				...
				setPressed: function (b, c) {
					...
					if (b) {
						...
						d.removeCls(g),
							(d.pressed = !1),
							d.toggleGroup && delete a[d.toggleGroup].active;
				...
				onClick: function (a) {
					...
					c.fire('click'),
						!0 !== c.disabled &&
							(d &&
								(b.isString(d) && (d = c.getHandler(d)),
								c.scope ? d.apply(c.scope, [c]) : d(c)),
							c.enableToggle &&
								(c.toggleGroup
									? c.pressed
										? c.setPressed(!1)
										: c.setPressed(!0)
									: c.toggle()),
							c.menu && (c.toggleMenuShow(a), c.toggle()));
				},
				...
				renderTip: function (a) {
					...
					c.tooltip && c.tooltip.destroy(),
						(c.tooltip = new b.ToolTip({ text: c.tip })),
						c.tooltip.css('display', 'block'),
						c.tooltip.show(a.pageX + 15, a.pageY - 25);
				},
				onMouseOut: function () {
					var a = this;
					a.fire('mouseout'),
				...
				setText: function (a, b) {
					...
					switch (
						...
						c.theme &&
							Fancy.themes[c.theme] &&
							(e = Fancy.themes[c.theme].config.charWidth),
						c.i18n)
					) {
						case 'zh-CN':
						case 'zh-TW':
					...
					b || (b = 0),
						b ||
							...
							c.imageColor && (c.imageCls = i),
							b < c.minWidth &&
								(b = (c.text && c.text.length, c.minWidth)),
							c.imageCls && c.text && (b += c.imageWidth),
							c.menu && (b += c.rightImageWidth)),
						c.css('width', b),
						d.select('.' + j).update(a);
				},
				disable: function () {
				...
				toggleMenuShow: function () {
					var a = this,
						c = a.el.$dom.offset(),
						d = [c.left, c.top + a.el.$dom.height()];
					if (a.pressed) return void a.menu.hide();
					b.isArray(a.menu)
						? a.initMenu()
						: a.menu.type || a.initMenu(),
						setTimeout(function () {
				...
				initMenu: function () {
					var a = this,
						c = {
							theme: a.theme,
							events: [{ hide: a.onMenuHide, scope: a }],
						};
					b.isObject(a.menu)
						? b.apply(c, a.menu)
						: (c.items = a.menu),
		...
		Fancy.define('Fancy.SegButton', {
			...
			render: function () {
				...
				b.fire('beforerender'),
					...
					c.addCls(Fancy.cls, b.widgetCls, b.cls, b.extraCls),
					b.hidden && c.css('display', 'none'),
			...
			renderButtons: function () {
				for (
					var a = this,
						...
						c = 0,
						d = b.length,
						e = Fancy.id(null, 'fancy-toggle-group-');
					c < d;
					c++
				) {
					var f = b[c];
					(f.renderTo = a.el.dom),
						!1 !== a.allowToggle &&
							((f.enableToggle = !0),
							!0 !== a.multiToggle && (f.toggleGroup = e)),
						0 === c
							? ((f.style = {
							  ...
							  1 === d && delete f.style['border-right-width'])
							: (f.style =
									c > 1
										? {
												'border-left-width': 0,
			...
			getValues: function () {
				for (
					var a = this, b = [], c = a.items, d = 0, e = c.length;
					d < e;
					d++
				)
					b.push(c[d].pressed);
			...
			clear: function (a) {
				for (
					var b = this, c = b.items, d = 0, e = c.length;
					d < e;
					d++
				)
					c[d].setPressed(!1, a);
			...
			setValue: function (a) {
				var b = this,
					c = b.items;
				switch ((b.clear(!1), Fancy.typeOf(a))) {
					case 'array':
						Fancy.each(a, function (a) {
							switch (Fancy.typeOf(a)) {
								case 'string':
									Fancy.each(c, function (b) {
										b.value === a && b.setPressed(!0, !0);
									});
									break;
								case 'number':
									c[a].setPressed(!0, !0);
		...
		(function () {
			...
			Fancy.Mixin('Fancy.panel.mixin.PrepareConfig', {
				prepareConfigTheme: function (a, b) {
					...
					return (
						Fancy.isObject(c) && (a.theme = c.name),
						Fancy.applyIf(a, d),
						a.theme && (this.theme = a.theme),
						a
					);
				},
				prepareConfigFooter: function (a) {
					...
					if (f) {
						var h = [];
						if (
							(Fancy.isString(f.status) &&
								h.push({ type: 'text', text: f.status, cls: b }),
							f.status && f.source && h.push('side'),
							Fancy.isString(f.source))
						)
							h.push({ type: 'text', text: f.source, cls: e });
				...
				prepareConfigLang: function (a, b) {
					...
					if (a.lang) {
						for (var e in a.lang)
							switch (Fancy.isObject(a.lang[e])) {
								case !1:
								case void 0:
									d[e] = a.lang[e];
							}
						...
						for (var e in a.lang.paging)
							'paging' !== e &&
								(Fancy.isObject(e) || (d[e] = a.lang.paging[e]));
						(d.date = {}),
		...
		Fancy.Mixin('Fancy.panel.mixin.Resize', {
			...
			onResize: function () {
				...
				b &&
					'grid' === b.type &&
					b.infinite &&
					(delete b.numOfVisibleCells, b.update());
			},
			...
			onMouseDownResizeEl: function (a) {
				...
				if (
					...
					Fancy.nojQuery &&
						b.el
							.select('.' + Fancy.GRID_ANIMATION_CLS)
							.removeCls(Fancy.GRID_ANIMATION_CLS),
					Fancy.isTouch)
				) {
					a = a.originalEvent || a;
					var d = a.changedTouches[0];
					c.once('touchend', b.onMouseUpResize, b),
						c.on('touchmove', b.onMouseMoveResize, b),
						b.renderResizeMask(),
						(b.startClientX = d.clientX),
						(b.startClientY = d.clientY);
				} else
			...
			onMouseUpResize: function () {
				...
				delete a.activeResizeEl,
					...
					Fancy.nojQuery &&
						a.el
							.select('.fancy-grid')
							.addCls(Fancy.GRID_ANIMATION_CLS);
			},
			onMouseMoveResize: function (a) {
				...
				a.preventDefault(),
					...
					i < b.minHeight && (i = b.minHeight),
					(b.newResizeWidth = h),
					(b.newResizeHeight = i),
					b.resizeMaskEl.css({ width: h, height: i });
			},
		...
		(function () {
			...
			a.define('Fancy.Panel', {
				...
				theme: 'default',
				tpl: [
					'<div style="height:{titleHeight}px;" class="' +
						e +
						' ' +
						b +
						'">',
					...
					'<div class="' + h + '"></div>',
					'</div>',
					'<div style="height:{subTitleHeight}px;" class="' +
						i +
						' ' +
						b +
						'">',
					'<div class="' + f + '">{subTitle}</div>',
					'</div>',
					'<div class="' + j + '">',
					'<div class="' +
						l +
						' ' +
						b +
						'" style="height:{tbarHeight}px;"></div>',
					'<div class="' +
						m +
						' ' +
						b +
						'" style="height:{subTBarHeight}px;"></div>',
					'<div class="' + k + '"></div>',
					'<div class="' +
						o +
						' ' +
						b +
						'" style="height:{bbarHeight}px;"></div>',
					'<div class="' +
						n +
						' ' +
						b +
						'" style="height:{buttonsHeight}px;"></div>',
					'<div class="' +
						s +
						' ' +
						b +
				...
				render: function () {
					...
					d.renderOuter && (g = f),
						f.dom ||
							a.error(
								'Could not find renderTo element: ' + d.renderTo,
								1
							),
						!0 === d.window &&
							g.css({ display: 'none', position: 'absolute' }),
						!1 === d.frame && g.addCls(q),
						g.addCls(a.cls, d.cls, d.fieldCls),
						'default' !== d.theme &&
							g.addCls(Fancy.getThemeCSSCls(d.theme)),
						d.shadow && g.addCls(r),
						g.css({
							width: d.width + 'px',
							height: d.height - 0 + 'px',
						}),
					...
					a.isObject(d.title)
						? (t = d.title.text)
						: a.isString(d.title) && (t = d.title),
						a.isObject(d.subTitle)
							? (u = d.subTitle.text)
							: a.isString(d.subTitle) && (u = d.subTitle);
					var v = '';
					a.isObject(d.title) &&
						d.title.imgCls &&
						(v =
							'<div class="' + p + ' ' + d.title.imgCls + '"></div>'),
						g.update(
							d.tpl.getHTML({
								titleImg: v,
								barHeight: d.barHeight,
								subTBarHeight: d.subTBarHeight || d.barHeight,
								tbarHeight: d.tbarHeight || d.barHeight,
								bbarHeight: d.bbarHeight || d.barHeight,
								buttonsHeight: d.buttonsHeight || d.barHeight,
								titleHeight: h,
								subTitleHeight: k,
								title: t,
								subTitle: u,
						...
						a.isObject(d.title) &&
							(d.title.style && g.select('.' + e).css(d.title.style),
							d.title.cls && g.select('.' + e).addCls(d.title.cls),
							d.title.tools && (d.tools = d.title.tools)),
						a.isObject(d.subTitle) &&
							(d.subTitle.style &&
								g.select('.' + i).css(d.subTitle.style),
							d.subTitle.cls &&
								g.select('.' + i).addCls(d.subTitle.cls)),
						d.title
							? g.select('.' + e).removeCls(b)
							: g.select('.' + j).css('border-top-width', '0px'),
						d.subTitle &&
							(g.select('.' + j).css('border-top-width', '0px'),
							g.select('.' + i).removeCls(b)),
						d.tbar && g.select('.' + l).removeCls(b),
						d.subTBar && g.select('.' + m).removeCls(b),
						d.bbar && g.select('.' + o).removeCls(b),
						d.buttons && g.select('.' + n).removeCls(b),
						d.footer && g.select('.' + s).removeCls(b),
						d.renderOuter
							? (d.el = g)
							: ((d.el = f.dom.appendChild(g.dom)),
							  (d.el = a.get(d.el))),
						d.modal &&
							0 === a.select(c).length &&
							a
						...
						d.id && !d.el.attr('id') && d.el.attr('id', d.id),
						d.renderTools(),
						d.renderBars(),
						d.setHardBordersWidth();
				},
				...
				renderTools: function () {
					...
					void 0 !== c &&
						a.each(c, function (c, d) {
							(c.renderTo = b.el.select('.' + h).dom),
								(b.tools[d] = new a.Tool(c, b.scope || b));
						});
				},
				renderBars: function () {
					var b = this,
					...
					b.items &&
						b.items[0] &&
						('grid' === b.items[0].type && (c = !0),
						(e = b.items[0])),
						b.bbar &&
							((b._bbar = new a.Bar({
								el: b.el.select('.' + o),
								items: b.bbar,
								height: b.bbarHeight || b.barHeight,
								barContainer: b.barContainer,
								barScrollEnabled: b.barScrollEnabled,
								tabScrollStep: b.tabScrollStep,
								hidden: !0 === b.bbarHidden,
								scope: e,
								theme: d,
								i18n: this.i18n,
							})),
							(b.bbar = b._bbar.items)),
						b.buttons &&
							((b._buttons = new a.Bar({
								el: b.el.select('.' + n),
								items: b.buttons,
								height: b.buttonsHeight || b.barHeight,
								barScrollEnabled: b.barScrollEnabled,
								tabScrollStep: b.tabScrollStep,
								hidden: !0 === b.buttonsHidden,
								scope: e,
								theme: d,
							})),
							(b.buttons = b._buttons.items)),
						b.tbar &&
							((b._tbar = new a.Bar({
								el: b.el.select('.' + l),
								items: b.tbar,
								height: b.tbarHeight || b.barHeight,
								tabEdit: !b.subTBar && c,
								barScrollEnabled: b.barScrollEnabled,
								tabScrollStep: b.tabScrollStep,
								hidden: !0 === b.tbarHidden,
								scope: e,
								theme: d,
							})),
							(b.tbar = b._tbar.items)),
						b.subTBar &&
							((b._subTBar = new a.Bar({
								el: b.el.select('.' + m),
								items: b.subTBar,
								height: b.subTBarHeight || b.barHeight,
								tabEdit: c,
								barScrollEnabled: b.barScrollEnabled,
								tabScrollStep: b.tabScrollStep,
								hidden: !0 === b.subTBarHidden,
								scope: e,
								theme: d,
							})),
							(b.subTBar = b._subTBar.items)),
						b.footer &&
							((b._footer = new a.Bar({
								disableScroll: !0,
								el: b.el.select('.' + s),
				...
				showAt: function (b, c) {
					this.css({
						...
						void 0 !== c && this.css({ top: c + 'px' });
				},
				show: function () {
					var b = this;
					if ((b.el.show(), !0 === b.window)) {
						b.buttons && b._buttons.checkScroll(),
							b.tbar && b._tbar.checkScroll(),
							b.bbar && b._bbar.checkScroll(),
							b.subTBar && b._subTBar.checkScroll();
						var d = a.getViewSize(),
							e = b.el.height(),
							f = b.el.width(),
							g = [],
				...
				hide: function () {
					var b = this;
					b.css({ display: 'none' }),
						b.modal && a.select('.' + c).css('display', 'none'),
				...
				setActiveWindowWatcher: function () {
					...
					b.el.on('mousedown', function (c) {
						a.get(c.target).hasCls(t) ||
							(1e3 + a.zIndex - 1 > parseInt(b.css('z-index')) &&
								b.css('z-index', 1e3 + a.zIndex++),
							a
								.get(document.body)
								.select('.fancy-active-panel')
								.removeCls('fancy-active-panel'),
							b.el.addCls('fancy-active-panel'));
					});
				},
			});
		})(),
		(function () {
			...
			a.define('Fancy.Tool', {
				...
				render: function () {
					...
					b.fire('beforerender'),
						(d.className = 'fancy-tool-button'),
						(d.innerHTML = b.text),
						(b.el = a.get(c.appendChild(d))),
						b.fire('afterrender'),
						b.fire('render');
				},
				onClick: function () {
			...
			a.define(['Fancy.panel.Tab', 'Fancy.Tab', 'FancyTab'], {
					...
					var c = this,
						d = function () {
							Fancy.isDom(a)
								...
								: (b = a),
								(b = b || {}),
								b.renderOuter && (b.renderTo = b.renderOuter),
								Fancy.loadStyle(),
								c.prepareConfigTheme(b),
								c.prepareConfigSize(b),
								Fancy.applyConfig(c, b),
								c.Super('const', arguments);
						};
					Fancy.fullBuilt || !1 === Fancy.MODULELOAD
						? d()
						: !Fancy.nojQuery ||
						  Fancy.modules.dom ||
						  Fancy.modules.grid
				...
				render: function () {
					...
					a.Super('render', arguments),
						Fancy.loadingStyle &&
							(a.el.css('opacity', 0),
							(a.intervalStyleLoad = setInterval(function () {
								Fancy.loadingStyle ||
									(clearInterval(a.intervalStyleLoad),
									a.el.animate({ opacity: 1, force: !0 }));
							}, 100))),
						(a.panelBodyEl = a.el.select('.' + b).item(0)),
						a.setPanelBodySize(),
						a.renderTabWrappers(),
						a.wrapped || a.el.addCls(c),
						a.el.addCls(g),
						(a.rendered = !0);
				},
				ons: function () {
					...
					b.responsive &&
						a.$(window).bind('resize', function () {
							b.onWindowResize(),
								clearInterval(b.intWindowResize),
								(b.intWindowResize = setTimeout(function () {
									b.onWindowResize(),
										delete b.intWindowResize,
										setTimeout(function () {
											b.onWindowResize();
										}, 300);
								}, 30));
				...
				onWindowResize: function () {
					var b,
						c = this,
						e = c.renderTo;
					c.panel && (e = c.panel.renderTo),
						(b = c.responsive
							? a.get(e)
							: c.panel
							? c.panel.el
							: a.get(e)),
						(b.hasClass(h) || b.hasClass(i)) && (b = b.parent());
					var f = b.width();
					if (void 0 !== b.dom) {
						if (
							(0 === f && (f = b.parent().width()),
							c.responsive && c.setWidth(f),
							c.responsiveHeight)
						) {
							var g = parseInt(b.height());
							0 === g && (g = parseInt(b.parent().height())),
								c.setHeight(g);
						}
						c.setPanelBodySize();
						c.el
							.select('.' + d + ' .' + h + ':first-child')
							.each(function (a) {
				...
				setPanelBodySize: function () {
					...
					a.title && (b -= a.titleHeight),
						a.subTitle && ((b -= a.subTitleHeight), (b += c[2])),
						a.bbar && (b -= a.bbarHeight || a.barHeight),
						a.tbar && (b -= a.tbarHeight || a.barHeight),
						a.subTBar && (b -= a.subTBarHeight || a.barHeight),
						a.buttons && (b -= a.buttonsHeight || a.barHeight),
						a.footer && (b -= a.barHeight),
						(b -= c[0] + c[2]),
						a.panelBodyEl.css({ height: b }),
						(a.panelBodyHeight = b),
				...
				prepareConfigSize: function (a) {
					...
					if (
						(void 0 === a.width &&
							...
							((a.responsive = !0),
							(b = Fancy.get(c)),
							(a.width = parseInt(b.width()))),
						void 0 === a.height && c)
					) {
						(a.responsiveHeight = !0), (b = Fancy.get(c));
						var d = parseInt(b.height());
						d < 50 && (d = parseInt(b.parent().css('height'))),
							(a.height = d);
					}
				},
				prepareTabs: function () {
					for (
						var a = this, b = [], c = 0, d = a.items.length;
						c < d;
						c++
					) {
						var e = a.items[c],
						...
						e.tabTitle
							? (f.text = e.tabTitle)
							: e.title && ((f.text = e.title), delete e.title),
				...
				renderTabWrappers: function () {
					...
					a.each(b.items, function (c) {
						...
						e.addCls(d),
							(c.renderTo = b.panelBodyEl.dom.appendChild(e.dom));
					});
				},
				setActiveTab: function (a) {
					var b = this,
						...
						g = b.activeTab;
					if (0 !== b.items.length) {
						c.item(b.activeTab).removeCls(e),
							(b.activeTab = a),
							c.item(b.activeTab).addCls(e);
						var h = b.items[b.activeTab];
						if (
							((h.theme = b.theme),
							(h.wrapped = !0),
							(h.width = b.panelBodyWidth),
							(h.height = b.panelBodyHeight),
							h.rendered)
						)
							b.setActiveItemWidth(), b.setActiveItemHeight();
						else
							switch (h.type) {
								case 'form':
						...
						b.tabs &&
							(b.tbar[g].removeCls(f), b.tbar[b.activeTab].addCls(f));
					}
				},
				setWidth: function (a) {
					var b = this;
				...
				!a.nojQuery &&
					a.$ &&
					(a.$.fn.FancyTab = function (b) {
						return (
							this.selector
								? (b.renderTo = a.$(this.selector)[0].id)
								: (b.renderTo = this.attr('id')),
							new FancyTab(b)
						);
					});
		})(),
			...
			a.define('Fancy.Bar', {
				...
				renderEl: function () {
					...
					if (!b.el) {
						...
						c.addCls(b.widgetCls, b.cls),
							c.update(b.text),
							(b.el = a.get(b.renderTo.appendChild(c.dom))),
							b.style && b.el.css(b.style);
					}
					b.hidden && b.el.css('display', 'none');
					var d = a.get(document.createElement('div'));
					d.addCls(b.containerCls),
						(b.containerEl = a.get(b.el.dom.appendChild(d.dom)));
				},
				renderItems: function () {
					for (
						...
						switch (
							(g && ((k = d[i]), i--),
							k.toggleGroup && (k.enableToggle = !0),
							a.isObject(k) && (k.type = k.type || 'button'),
							g &&
								((b.floating = 'right'),
								(k.style = k.style || {}),
								(k.style.right = j)),
							a.isObject(k) && (k.renderTo = c.dom),
							k)
						) {
							case '|':
								var l = {
								...
								'right' === b.floating &&
									...
									h.push(
										new a.Separator({ renderTo: c.dom, style: l })
									);
								continue;
							case 'side':
							case '->':
							...
							default:
								g
									? (h[i] = b.renderItem(k))
									: h.push(b.renderItem(k));
						}
						g &&
							(k.text
								? (j += 7 * k.text.length + 5 + 5 + 5)
								: k.width && (j += k.width + 5),
							k.imageCls &&
								(k.imageWidth ? (j += k.imageWidth) : (j += 20)),
							(j += 3));
					}
					b.items = h;
				},
				renderItem: function (c) {
					...
					switch (
						...
						(c.padding = !1),
						(c.theme = e.theme),
						a.applyIf(c.style, { float: e.floating }),
						'right' === e.floating &&
							a.applyIf(c.style, {
								right: e.sideRight,
								position: 'absolute',
							}),
						!c.scope && e.scope && (c.scope = e.scope),
						c.type)
					) {
						case 'wrapper':
							...
							for (
								...
								(t = c.items[v]),
									a.isObject(t) && (t.type = t.type || 'button'),
									(t.renderTo = u.dom),
									(d = e.renderItem(t));
								var y = d.el;
								v === w - 1
									? y.css('margin-right', '0px')
									: (x += parseInt(y.css('margin-right'))),
									a.nojQuery
										? (x += parseInt(y.width()))
										: (x += parseInt(y.$dom.outerWidth())),
									(x += parseInt(y.css('margin-left')));
							}
							u.css('width', x);
							break;
						case void 0:
						case 'button':
							(c.extraCls = f),
								(c.scope = c.scope || e.scope),
								(d = new a.Button(c));
							break;
						case 'segbutton':
							(c.extraCls = g),
								a.applyIf(c.style, { 'margin-right': '6px' }),
								(d = new a.SegButton(c));
							break;
						case 'tab':
						...
						case 'text':
							e.isFooter ||
								...
								a.apply(c, { renderTo: h.dom, cls: c.cls || '' }),
								(d = new a.bar.Text(c));
							break;
						case 'combo':
							(c.inputWidth = 18),
						...
						case 'search':
								...
								(c.events = c.events.concat([
									...
									},
									{
										key: function (c, d) {
											...
											(f.filter && !1 === f.filter.autoEnterDelay) ||
												(e.autoEnterTime ||
													(e.autoEnterTime = new Date()),
												clearInterval(e.intervalAutoEnter),
												delete e.intervalAutoEnter,
												(e.intervalAutoEnter = setInterval(
													function () {
														new Date() - e.autoEnterTime > 500 &&
															(clearInterval(e.intervalAutoEnter),
															delete e.intervalAutoEnter,
															(d = c.getValue()),
															f.search(d),
															f.expander && f.expander.reSet());
													},
													200
												)));
										},
												...
												c.el.on(
													...
													function (f) {
														var g = !1,
															...
															q = m.length,
															r = 1;
														if (h.searching.items)
															a.each(h.searching.items, function (a) {
																o.push({
																	inputLabel:
																		' &nbsp;&nbsp;' + a.text,
																	value: !0,
														...
														if (d.list) {
															if ('none' !== d.list.el.css('display'))
																return void d.list.el.css(
																	'display',
																	'none'
																);
															g = !0;
															...
															var u = 0;
															a.each(o, function (a) {
																a.inputLabel.replace(/\&nbsp\;/g, '')
																	.length > u &&
																	(u = a.inputLabel.length);
															});
															var v = 150;
															u > 15 && (v = 9 * u),
																(d.list = new FancyForm({
																	width: v,
																	height: r,
																	theme: i,
																	defaults: {
														...
														var w = a.get(f.target),
															x = w.offset(),
															y = parseInt(c.el.css('height'));
														d.list &&
															d.list.el &&
															(d.list.css({
																position: 'absolute',
							...
							c.paramsMenu &&
								((c.tpl = [
									'<div class="' +
										j +
										'" style="{labelWidth}{labelDisplay}">',
									'{label}',
									'</div>',
									'<div class="' + k + '">',
									'<input placeholder="{emptyText}" class="' +
										l +
										'" style="{inputWidth}" value="{value}">',
									'<div class="' +
										o +
										'" style="">' +
										(c.paramsText || '&nbsp;') +
					...
					return (
						'right' === e.floating &&
							((e.sideRight += d.width), (e.sideRight += 7)),
						c.role && (e.roles[c.role] = d),
						d
					);
				},
				initScroll: function () {
					...
					(b.leftScroller = new a.Button({
						...
						listeners: [{ click: b.onPrevScrollClick, scope: b }],
					})),
						(b.rightScroller = new a.Button({
							...
							listeners: [{ click: b.onNextScrollClick, scope: b }],
						}));
				},
				...
				getItemsWidth: function () {
					...
					return (
						a.each(this.items, function (c) {
							'none' !== c.el.css('display') &&
								((b += c.el.width()),
								(b += parseInt(c.el.css('margin-left'))),
								(b += parseInt(c.el.css('margin-right'))),
								a.nojQuery ||
									((b += parseInt(c.el.css('padding-right'))),
									(b += parseInt(c.el.css('padding-left'))),
									(b += parseInt(c.el.css('border-left-width'))),
									(b += parseInt(c.el.css('border-right-width')))));
						}),
						b
					);
				},
				onPrevScrollClick: function () {
					var a = this;
					(a.scrolled += a.tabScrollStep),
						a.scrolled > -20 && (a.scrolled = 0),
				...
				applyScrollChanges: function () {
					var a = this,
						b = a.getItemsWidth() + a.tabOffSet,
						c =
							a.getBarWidth() -
							parseInt(a.leftScroller.el.css('width')) -
							parseInt(a.rightScroller.el.css('width')) -
							2 * a.tabOffSet,
						d = b - c;
					if (
						(0 === a.scrolled
							? a.leftScroller.disable()
							: a.scrolled < 0 && a.leftScroller.enable(),
						b > c && 0 === a.scrolled && a.rightScroller.enable(),
						c + Math.abs(a.scrolled) < b && a.rightScroller.enable(),
						b < c)
					)
						return (
							(a.scrolled = 0),
							...
							void a.containerEl.css({ 'margin-left': '0px' })
						);
					a.scrolled > 0
						? ((a.scrolled = 0),
						  a.leftScroller.disable(),
						  a.rightScroller.enable())
						: a.scrolled < -d &&
						  ((a.scrolled = -d),
						...
						a.containerEl.css({
							'margin-left': a.scrolled + 20 + 'px',
						});
				},
				onDocMouseUp: function () {
					var a = this;
					a.scrollInterval &&
						(clearTimeout(a.scrollInterval), delete a.scrollInterval);
				},
				checkScroll: function () {
					...
					a.disableScroll ||
						(a.isParentHidden()
							? (a.checkVisInt = setInterval(function () {
									a.isParentHidden() ||
										(a.checkScroll(),
										clearInterval(a.checkVisInt),
										delete a.checkVisInt);
							  }, 300))
							: (clearInterval(a.checkVisInt), delete a.checkVisInt),
						b > c
							? a.enableScroll()
							: a.barScrollEnabled &&
							  (a.leftScroller.el.hide(),
				...
				enableScroll: function () {
					...
					a.barScrollEnabled &&
						...
						0 === a.scrolled &&
							(a.leftScroller.disable(),
							a.containerEl.css('margin-left', '20px')));
				},
				...
				isParentHidden: function (c, d) {
					...
					return (
						...
						'none' === c.css('display') ||
							(!(
								d > 5 || 'body' === c.dom.tagName.toLocaleLowerCase()
							) &&
								(d++, (c = c.parent()), e.isParentHidden(c, d))))
					);
				},
			});
		})(),
		...
		Fancy.define('Fancy.bar.Text', {
			...
			render: function () {
				var a = this,
					b = Fancy.get(document.createElement('div'));
				b.addCls(a.widgetCls, a.cls),
					b.update(a.text),
					(a.el = Fancy.get(a.renderTo.appendChild(b.dom))),
					a.style && a.el.css(a.style),
					a.hidden && a.el.css('display', 'none'),
					a.id && a.el.attr('id', a.id),
					a.width && a.el.css('width', a.width);
			},
			get: function () {
			...
			ons: function () {
				...
				b.on('mouseover', a.onMouseOver, a),
					b.on('mouseout', a.onMouseOut, a),
					a.tip && a.el.on('mousemove', a.onMouseMove, a);
			},
			onMouseMove: function (a) {
				var b = this;
				b.tip &&
			...
			renderTip: function (a) {
				var b = this,
					c = '';
				if ((b.tooltip && b.tooltip.destroy(), !0 === b.tip))
					b.tip = new Fancy.Template(b.tipTpl).getHTML({
						value: b.get(),
					});
				else
					switch (Fancy.typeOf(b.tip)) {
						case 'function':
				...
				b.tooltip
					? b.tooltip.update(c)
					: (b.tooltip = new Fancy.ToolTip({ text: c })),
		...
		Fancy.define(['Fancy.Form', 'FancyForm'], {
			...
			constructor: function (a, b) {
				var c = this;
				Fancy.isDom(a) ? ((b = b || {}), (b.renderTo = a)) : (b = a),
					(b = b || {});
				var d = function (a) {
						a && Fancy.apply(b, a),
							(b = c.prepareConfig(b, c)),
							Fancy.applyConfig(c, b),
							c.Super('const', arguments);
					},
					e = function () {
			...
			loadModules: function (a, b) {
				...
				(Fancy.modules = Fancy.modules || {}),
					Fancy.nojQuery && (d.dom = !0),
					Fancy.isTouch && (d.touch = !0),
					b.url && (d.ajax = !0);
				var e = function (a) {
				...
				Fancy.each(b.tbar, e),
					Fancy.each(b.bbar, e),
					Fancy.each(b.buttons, e),
					Fancy.each(b.subTBar, e);
				var f = function (a) {
					for (var b, c = 0, e = a.length; c < e; c++)
						(b = a[c]),
							'combo' === b.type &&
								...
								(d.ajax = !0),
							'date' === b.type &&
								((d.grid = !0), (d.date = !0), (d.selection = !0)),
							b.items && f(b.items);
				};
				f(b.items || []), (c.neededModules = { length: 0 });
				for (var g in d)
					void 0 === Fancy.modules[g] &&
						((c.neededModules[g] = !0), c.neededModules.length++);
				if (0 === c.neededModules.length)
					return (c.neededModules = !0), void a();
				var h = function (b) {
					delete c.neededModules[b],
						0 === --c.neededModules.length &&
							((c.neededModules = !0), a());
				};
				if (c.neededModules.dom)
					Fancy.loadModule('dom', function () {
						delete c.neededModules.dom, c.neededModules.length--;
						for (var a in c.neededModules)
							'length' !== a && Fancy.loadModule(a, h);
					});
				else
					for (var g in c.neededModules)
						'length' !== g && Fancy.loadModule(g, h);
			},
		}),
		...
		!Fancy.nojQuery &&
			Fancy.$ &&
			(Fancy.$.fn.FancyForm = function (a) {
				return (
					this.selector
						? (a.renderTo = Fancy.$(this.selector)[0].id)
						: (a.renderTo = this.attr('id')),
					new Fancy.Form(a)
				);
			}),
		(function () {
			...
			a.ns('Fancy.form.field'),
				(a.form.field.Mixin = function () {}),
				(a.form.field.Mixin.prototype = {
					...
					formatValue: function (a) {
						...
						var c = this.input.dom.selectionStart,
							d = this.input.dom.value;
						(this.input.dom.value = a),
							d.length < a.length && c++,
					...
					render: function () {
						...
						a.isString(i) &&
							((i = document.getElementById(i)) ||
								(i = a.select(i).item(0))),
							b.fire('beforerender'),
							l.addCls(a.cls, b.cls, b.fieldCls),
							l.attr('id', b.id);
						var m = '',
							n = '';
						b.itemsHTML && (n = b.itemsHTML),
							'top' === b.labelAlign &&
								b.label &&
								b.labelWidth < 7 * b.label.length &&
								(b.labelWidth = 7 * (b.label.length + 2)),
							b.labelWidth && (m = 'width:' + b.labelWidth + 'px;');
						var o = b.label;
						'' === b.label
							? (o = '&nbsp;')
							: void 0 === b.label
							? (o = '&nbsp;')
							: 'right' !== b.labelAlign && (o += ':');
						var p = '',
							q = '',
							r = '';
						if (
							(!1 === b.label && (p = 'display:none;'),
							b.inputLabel
								? (r = b.inputLabel)
								: (q = 'display:none;'),
							'recaptcha' === b.type)
						)
							l.update(b.tpl.getHTML({ key: b.key }));
						else {
							var s = {
								labelWidth: m,
								label: o,
							...
							'set' === b.type && delete s.height,
								l.update(b.tpl.getHTML(s));
						}
						if (
							((b.el = l),
							b.setStyle(),
							!0 === b.renderId && l.attr('id', b.id),
							j
								? ((j = a.get(j)),
								  (l = j.after(l.dom.outerHTML).next()))
								: k
								? (l = k.before(l.dom.outerHTML).prev())
								: i.appendChild(l.dom),
							(b.el = l),
							'textarea' === b.type
								? (b.input = b.el.getByTag('textarea'))
								: (b.input = b.el.getByTag('input')),
							b.name && (b.input.name = b.name),
							b.setSize(),
							'top' === b.labelAlign)
						)
							b.el.addCls(c),
								b.el.select('.' + d).css('float', 'none');
						else if ('right' === b.labelAlign)
							switch ((b.el.addCls(g), b.type)) {
								case 'radio':
									a
										.$(l.dom)
										.find('.' + e)
										.insertAfter(a.$(l.dom).find('.' + d + ':last')),
										a
											.$(l.dom)
											.find('.' + e)
											.css('float', 'right');
								...
								default:
									a.$(l.dom)
										.find('.' + e)
										.insertAfter(a.$(l.dom).find('.' + d));
							}
						else b.type;
						if (
							((b.acceptedValue = b.value),
							b.fire('afterrender'),
							b.fire('render'),
							'recaptcha' !== b.type &&
								'chat' !== b.type &&
							...
							b.input &&
								b.tabIndex &&
								b.input.attr('tabIndex', b.tabIndex);
					},
					onKeyDown: function (b) {
						var c = this,
							...
							e = a.key;
						if (
							(c.fire('beforekey', c.input.dom.value, b), !c.disabled)
						) {
							switch (d) {
								case e.BACKSPACE:
								case e.DELETE:
								...
								case e.ENTER:
									var f =
										'textarea' === c.type ||
										'field.textarea' === c.type;
									if (f && b.shiftKey) break;
									c.fire('enter', c.getValue()),
								...
								default:
									setTimeout(function () {
										c.input &&
											(0 === c.input.dom.value.length
												? (void 0 === c.prevColor &&
														(c.prevColor = c.input.css('color')),
												  c.input.css('color', 'grey'))
												: c.prevColor
												? c.input.css('color', c.prevColor)
												: c.input.css('color', ' '));
									}, 1);
							}
							setTimeout(function () {
					...
					onKey: function (a, b) {
						a.disabled ||
							(a.isValid() && !a.checkValidOnTyping) ||
							a.validate(b);
					},
					onBlur: function () {
						var a = this;
						...
						if ((a.fire('blur'), a.input)) {
							if ('combo' !== a.type)
								return a.validate(a.input.dom.value);
							setTimeout(function () {
					...
					validate: function (b) {
						...
						var e = a.isValid(d, b);
						return !0 !== e
							? ((c.errorText = new a.Template(e.text).getHTML(e)),
							  c.failedValid(),
							  !1)
							: (c.successValid(), !0);
					},
					...
					onFocus: function () {
						var a = this;
						if (a.disabled || !1 === a.editable)
							return void this.input.blur();
						a.fire('focus');
					},
					blur: function () {
						this.input.blur();
					...
					get: function () {
						...
						if (b.format)
							if (a.isString(b.format));
								...
								if (
									b.format.inputFn &&
									('number' === b.type || 'field.number' === b.type)
								)
					...
					failedValid: function () {
						var b = this;
						b.hasCls(b.failedValidCls)
							? b.tooltip && b.errorText && a.tip.update(b.errorText)
							: (!b.tooltip &&
									b.errorText &&
									(b.showErrorTip(),
									b.el.on('mousemove', b.onMouseMove, b),
									b.input.hover(
										function (c) {
											b.errorText &&
												(b.showErrorTip(),
												a.tip.show(c.pageX + 15, c.pageY - 25));
										},
										function () {
											b.hideErrorTip();
										}
					...
					setInputSize: function (a) {
						var b = this;
						'combo' === b.type &&
							b.inputContainer.css('width', a.width),
							a.width && b.input.css('width', a.width),
							a.height &&
								'set' !== b.type &&
								b.input.css('height', a.height);
					},
					focus: function () {
						var a = this;
						a.input.focus(),
							setTimeout(function () {
								a.input.dom.selectionStart =
									a.input.dom.selectionEnd = 1e4;
							}, 0);
					},
					hide: function () {
						var a = this;
					...
					setSize: function (a, b) {
						...
						void 0 !== a && c.css('width', a),
							'top' === c.labelAlign
								? c.css('height', 1.5 * b)
								: ('set' !== c.type && c.css('height', b),
								  c.label &&
										c.el
											.select('.' + e)
											.css('height', c.inputHeight)),
							c.setInputSize({
								width: c.inputWidth,
					...
					setStyle: function () {
						var b = this,
							...
							d = b.padding;
						d
							? (a.isNumber(d) ? (d += 'px') : a.isString(d),
							  void 0 === c.padding && (c.padding = d))
							: (c.padding = '0px'),
							b.hidden && b.css('display', 'none'),
							b.css(c);
					},
					preRender: function () {
						var b = this;
					...
					calcSize: function () {
						...
						if (a.isString(i))
							...
							a.isNumber(i)
								? (i = [i, i, i, i])
								: !1 === i && (i = [0, 0, 0, 0]);
						'top' === g.labelAlign && (g.height *= 1.5),
							(b = g.width),
							'top' !== g.labelAlign &&
								g.label &&
								(b -= g.labelWidth),
							g.height === g.inputHeight &&
								!1 !== g.padding &&
								(h -= i[0] + i[2]),
							'radio' !== g.type ||
								g.column ||
								(g.calcColumns(),
								1 !== g.rows && (h = (h - i[0] - i[2]) * g.rows)),
							(g.inputHeight = h),
							(g.inputWidth = b - i[1] - i[3]),
							(g.height = h + i[0] + i[2]);
					},
					setWidth: function (a) {
						var b = this;
						(b.width = a),
							b.calcSize(),
							b.css('width', a),
							b.setInputSize({ width: b.inputWidth });
					},
					onMouseMove: function (b) {
						...
						if (!c.disabled) {
							if (d) {
								if (d.startResizing && c.tooltip)
									return void a.tip.hide();
								if (
									d.columndrag &&
									'dragging' === d.columndrag.status
								)
									return void a.tip.hide();
							}
							c.tooltip
								? a.tip.show(b.pageX + 15, b.pageY - 25)
								: c.tip && c.renderTip(b);
						}
					},
					...
					getInputSelection: function () {
						...
						return (
							...
							'number' == typeof i.selectionEnd
								? ((g = i.selectionStart), (h = i.selectionEnd))
					...
					enable: function () {
						...
						(a.disabled = !1),
							a.removeCls(h),
							a.button && a.button.enable(),
							a.input && a.input.attr('tabIndex', a.tabIndex || 0);
					},
					disable: function () {
						var a = this;
						(a.disabled = !0),
							a.addCls(h),
							a.button && a.button.disable(),
							a.input && a.input.attr('tabIndex', -1);
					},
			...
			init: function () {
				...
				a.addEvents(
					...
					a.isPassword &&
						...
						a.showPassTip &&
							(a.el
								.select('.fancy-field-text')
								.item(0)
								.append(
									'<div class="fancy-field-pass-tip">abc</div>'
								),
							(a.passTipEl = a.el
								.select('.fancy-field-pass-tip')
								.item(0)),
							a.passTipEl.on('mousedown', function (a) {
								a.preventDefault();
							}),
							a.passTipEl.on('click', function () {
								'password' !== a.input.attr('type')
									? (a.passTipEl.update('abc'),
									  a.input.attr('type', 'password'),
									  a.passTipEl.css('line-height', '22px'))
									: (a.passTipEl.update('***'),
									  a.input.attr('type', ''),
									  a.passTipEl.css('line-height', '28px'));
							}))),
		...
		(function () {
			...
			Fancy.define(['Fancy.form.field.Number', 'Fancy.NumberField'], {
				...
				tpl: [
					...
					'</div>',
					'<div class="' + e + '">',
					'<input autocomplete="off" placeholder="{emptyText}" class="' +
						f +
						'" style="{inputWidth}" value="{value}">',
					'<div class="' + g + '">',
					'<div class="' + h + '"></div>',
					'<div class="' + i + '"></div>',
					'</div>',
					'<div class="' + d + '" style="{errorTextStyle}"></div>',
					'</div>',
					'<div class="' + a + '"></div>',
				],
				onInput: function () {
					...
					if (a.isValid()) {
						for (
							var e = b.dom.value, f = '', g = 0, h = e.length;
							g < h;
							g++
						)
							switch (e[g]) {
				...
				initSpin: function () {
					var a = this;
					!0 === a.spin &&
						(a.el.select('.' + g).css('display', 'block'),
						a.el
							.select('.' + h)
							.on('mousedown', a.onMouseDownSpinUp, a),
						a.el
							.select('.' + i)
							.on('mousedown', a.onMouseDownSpinDown, a));
				},
				...
				spinUp: function () {
					var a = this,
						b = +a.get() + a.step;
					Fancy.Number.isFloat(a.step) &&
						(b = Fancy.Number.correctFloat(b)),
						isNaN(b) && (b = a.min || 0),
						void 0 !== a.max && b > a.max
							? (b = a.max)
							: b < a.min && (b = a.min),
						a.set(b);
				},
		...
		(function () {
			...
			a.define(['Fancy.form.field.TextArea', 'Fancy.TextArea'], {
				...
				tpl: [
					...
					'</div>',
					'<div class="' + e + '">',
					'<textarea autocomplete="off" placeholder="{emptyText}" type="text" class="' +
						f +
						'" style="{inputWidth}height:{inputHeight}px;">{value}</textarea>',
					'<div class="' + g + '" style="{errorTextStyle}"></div>',
					'</div>',
					'<div class="' + h + '"></div>',
				],
				ons: function () {
					...
					(a.input = c),
						...
						c.on('keydown', a.onKeyDown, a),
						a.on('key', a.onKey, a),
						a.autoHeight && c.on('input', a.onChange, a),
				...
				preRender: function () {
					var b = this;
					b.tpl && (b.tpl = new a.Template(b.tpl)),
						b.initHeight(),
						b.calcSize();
				},
				initHeight: function () {
				...
				calcSize: function () {
					...
					if (a.isString(h))
						...
						a.isNumber(h)
							? (h = [h, h, h, h])
							: !1 === h && (h = [0, 0, 0, 0]);
					'top' === g.labelAlign && (g.inputHeight -= 40),
						(b = g.width),
						'top' !== g.labelAlign && g.label && (b -= g.labelWidth),
						g.height === g.inputHeight &&
							!1 !== g.padding &&
							(g.inputHeight -= h[0] + h[2]),
						(g.inputWidth = b - h[1] - h[3]),
						(g.height = g.inputHeight + h[0] + h[2]);
				},
				onChange: function () {
					var a = this,
						b = a.input.dom.value,
					...
					d < a.minHeight
						? ((d = a.minHeight), c.css({ 'overflow-y': 'hidden' }))
						: d > a.maxHeight
						? ((d = a.maxHeight), c.css({ 'overflow-y': 'scroll' }))
			...
			Fancy.define(['Fancy.form.field.CheckBox', 'Fancy.CheckBox'], {
				...
				init: function () {
					...
					a.addEvents(
						...
						a.expander && a.addCls('fancy-checkbox-expander'),
				...
				tpl: [
					...
					'<div class="' + f + '"></div>',
					'</div>',
					'<div class="' + g + '" style="{inputLabelDisplay}">',
					'{inputLabel}',
					'</div>',
					'<div class="' + a + '"></div>',
				],
				...
				onClick: function (a) {
					...
					if (
						...
						if (!0 === b.canceledChange)
							return void (b.canceledChange = !1);
						c.toggleCls(b.checkedCls);
						var d = b.value;
						(b.value = c.hasCls(b.checkedCls)),
							b.fire('change', b.value, d),
							!0 === b.middle && ((b.middle = !1), b.checkMiddle());
					}
				},
				onMouseDown: function (a) {
					a.preventDefault();
				...
				set: function (a, b) {
					var c = this,
						d = c.el;
					if (('' === a && (a = !1), !0 === a || 1 === a))
						d.addCls(c.checkedCls), (a = !0);
					else if (!1 === a || 0 === a)
						d.removeClass(c.checkedCls), (a = !1);
					else {
						if (void 0 !== a)
							throw new Error(
								'[FancyGrid Error] - not right value for checkbox ' +
									a
							);
						a = !1;
					}
				...
				checkMiddle: function () {
					var a = this;
					a.middle
						? a.el.addCls('fancy-checkbox-middle')
						: a.el.removeCls('fancy-checkbox-middle');
				},
			...
			a.define('Fancy.combo.Manager', {
				...
				a.define(['Fancy.form.field.Combo', 'Fancy.Combo'], {
					...
					tpl: [
						...
						'<div class="' +
							o +
							'" style="{inputHeight}cursor:default;">&nbsp;</div>',
						'<input autocomplete="off" placeholder="{emptyText}" class="' +
							k +
							'" style="{inputHeight}cursor:default;" value="{value}">',
						'<div class="' + m + '">&nbsp;</div>',
						'</div>',
						'</div>',
						'<div class="' + j + '" style="{errorTextStyle}"></div>',
						'<div class="' + i + '"></div>',
					],
					constructor: function () {
						(this.tags = this.tags || []),
					...
					init: function () {
						...
						a.addEvents(
							...
							a.Super('init', arguments),
							a.subSearch && (a.editable = !1),
							a.loadListData() ||
								((a.data = a.configData(a.data)),
								(a.data = Fancy.Array.copy(a.data))),
							a.multiSelect && a.data.length && a.initMultiSelect(),
							a.preRender(),
							a.render(),
							a.ons(),
							a.applyStyle(),
					...
					loadListData: function () {
						...
						if (!c || !c.url)
							throw new Error(
								'[FancyGrid Error]: combo data url is not defined'
							);
						return (
							c.reader && c.reader.root && (d = c.reader.root),
							a.Ajax({
								url: c.url,
								params: c.params || {},
								method: c.method || 'GET',
								...
								success: function (a) {
									if (
										((b.data = b.configData(a[d])),
										b.renderList(),
										b.onsList(),
										b.multiSelect)
									)
										b.initMultiSelect(), b.value && b.updateInput();
									else if (b.value) {
					...
					applyTheme: function () {
						...
						a.theme &&
							'default' !== a.theme &&
							(a.addCls(Fancy.getThemeCSSCls(a.theme)),
							a.list.addCls(Fancy.getThemeCSSCls(a.theme)),
							a.aheadList &&
								a.aheadList.addCls(Fancy.getThemeCSSCls(a.theme)));
					},
					ons: function () {
						var a = this,
							b = a.el,
						...
						(a.input = a.el.getByTag('input')),
							(a.inputContainer = a.el.select('.' + n)),
							(a.drop = c),
							a.onsList(),
							a.input.on('blur', a.onBlur, a),
							a.input.on('mousedown', a.onInputMouseDown, a),
							a.input.on('click', a.onInputClick, a),
							c.on('mousedown', a.onDropMouseDown, a),
							c.on('click', a.onDropClick, a),
							a.on('key', a.onKey, a),
							a.typeAhead &&
								a.editable &&
								a.input.on('keydown', a.onKeyDown, a),
							a.on('esc', a.onEsc, a),
					...
					onKeyDown: function (b) {
						...
						switch (d) {
							...
							case e.BACKSPACE:
								setTimeout(function () {
									if (0 === c.input.dom.value.length)
										(c.value = -1),
											(c.valueIndex = -1),
											c.hideAheadList(),
											c.multiSelect &&
												((c.values = []), c.clearListActive()),
											c.fire('empty');
									else {
										if (
											(c.multiSelect &&
												(c.input.dom.value.split(',').length,
												c.valuesIndex.length),
											0 === c.generateAheadData().length)
										)
											return void c.hideAheadList();
							...
							default:
								setTimeout(function () {
									if (0 === c.generateAheadData().length)
										return void c.hideAheadList();
									c.renderAheadList(), c.showAheadList();
								}, 1);
						}
					...
					onDropClick: function () {
						...
						b.disabled ||
							('none' === c.css('display')
								? (a.combo.Manager.add(this), b.showList())
								: b.hideList(),
							!0 === b.editable && b.input.focus());
					},
					showList: function () {
						var b = this,
							c = b.list,
						...
						if ((b.hideAheadList(), b.list && 0 !== b.data.length)) {
							...
							var l = c.select('.' + h);
							0 === l.length
								? b.multiSelect && b.values.length
									? b.valuesIndex.each(function (a, b, d) {
											void 0 === k && (k = a),
												c.select('li').item(a).addCls(h);
									  })
									: (k = 0)
								: (b.multiSelect &&
										l.length !== b.valuesIndex.length &&
										(c.select('.' + h).removeCls(h),
										b.valuesIndex.each(function (a, b, d) {
											void 0 === k && (k = a),
												c.select('li').item(a).addCls(h);
										})),
								  (k = l.item(0).index())),
								-1 === k && (k = 0),
								c.select('li').item(k).addCls(i),
								b.scrollToListItem(k),
								b.docSpy ||
									((b.docSpy = !0), g.on('click', b.onDocClick, b)),
								!1 !== b.subSearch &&
									b.subSearchField &&
					...
					showAheadList: function () {
						...
						b.hideList(),
							c &&
								...
								b.docSpy2 ||
									((b.docSpy2 = !0), g.on('click', b.onDocClick, b)));
					},
					...
					hideAheadList: function () {
						...
						if (
							b.aheadList &&
							(b.aheadList.css('display', 'none'), b.docSpy)
						) {
							var c = a.get(document);
							(b.docSpy = !1), c.un('click', b.onDocClick, b);
						}
					...
					onsList: function () {
						var a = this;
						a.list.on('mousedown', a.onListItemMouseDown, a, 'li'),
							a.list.on('click', a.onListItemClick, a, 'li'),
							a.list.on('mouseenter', a.onListItemOver, a, 'li'),
							a.list.on('mouseleave', a.onListItemLeave, a, 'li'),
							a.selectAllText &&
								a.list
									.select('.fancy-combo-list-select-all')
									.on('click', a.onSelectAllClick, a);
					},
					...
					onListItemOver: function (b) {
						if (!this.disabled) {
							...
							'li' === c.prop('tagName').toLocaleLowerCase() &&
								c.addCls(this.focusedItemCls);
						}
					},
					...
					onListItemClick: function (b) {
						...
						c.disabled ||
							(a.nojQuery && 0 === e && (e = ''),
							c.multiSelect
								? (0 === c.values.length && c.clearListActive(),
								  c.clearFocused(),
								  'list' === c.getTypeActiveList() && d.toggleCls(f),
								  d.hasCls(f)
										? (c.addValue(e), d.addCls(g))
										: (c.removeValue(e),
										  c.clearFocused(),
										  c.selectAllText &&
												c.list
													.select('.fancy-combo-list-select-all')
													.removeCls('fancy-combo-item-selected')),
								  c.updateInput())
								: (c.set(e), c.hideList()),
							c.editable ? c.input.focus() : c.onBlur());
					},
					...
					set: function (b, c) {
						...
						if (
							(e.multiSelect &&
								!a.isArray(b) &&
								(b = -1 === b ? [] : [b]),
							a.isArray(b) && e.multiSelect)
						) {
							var g = [];
							e.valuesIndex.removeAll(),
								a.each(b, function (a, c) {
									var d = e.getIndex(a);
									-1 !== d &&
										(e.valuesIndex.add(d, b[c]),
										g.push(e.data[d][e.displayKey]),
										(f = g.join(', ')));
								}),
								(e.values = b),
								(d = e.getIndex(b[0])),
							...
							(d = e.getIndex(b)),
								-1 !== d
									? ((e.valueIndex = d),
									  (f = e.data[d][e.displayKey]),
									  e.selectItem(d))
									: -1 !== b && b && b.length > 0
									? ((f = ''), (e.value = -1), (e.valueIndex = -1))
									: (f = ''),
								(e.value = b);
						(e.input.dom.value = f),
							!1 !== c && e.onInput(),
							e.left && e.updateLeft(),
							Fancy.isObject(e.data) || e.validate(f);
					},
					addValue: function (a) {
						var b = this,
							c = b.getIndex(a);
					...
					removeValue: function (b) {
						...
						a.each(c.values, function (a, c) {
							String(a).toLocaleLowerCase() ===
								String(b).toLocaleLowerCase() && (d = c);
						}),
							-1 !== d &&
								(c.values.splice(d, 1),
								c.valuesIndex.remove(c.getIndex(b))),
							c.values.length
								? (c.value = c.values[c.values.length - 1])
								: ((c.value = -1), (c.valueIndex = -1));
					},
					...
					selectItem: function (a) {
						...
						if (b.list) {
							...
							b.list
								.select('li')
								.item(a)
								.addCls(b.focusedItemCls, b.selectedItemCls);
						}
					},
					render: function () {
						var b = this,
						...
						d.attr('id', b.id),
							void 0 === e
								...
								: b.multiSelect &&
								  ...
								  b.data.length > 0
								? ((e = ''),
								  b.valuesIndex.each(function (a, c) {
										-1 === f && ((f = a), (b.valueIndex = a)),
											b.data[a] &&
												(e += b.data[a][b.displayKey] + ', ');
								  }),
								  (e = e.replace(/, $/, '')))
								: ((f = b.getIndex(e)),
								  -1 !== f
										? ((b.valueIndex = f),
										  (e = b.data[f][b.displayKey]))
										: (e = '')),
							b.fire('beforerender'),
							d.addCls(a.cls, b.cls, b.fieldCls);
						var i = '';
						...
						'' === b.label
							...
							: void 0 === b.label
							? (j = '&nbsp;')
							: 'right' !== b.labelAlign && (j += ':'),
							d.update(
								b.tpl.getHTML({
									labelWidth: i,
									labelDisplay:
										!1 === b.label ? 'display: none;' : '',
									label: !1 === j ? '' : j,
									emptyText: b.emptyText,
							...
							b.setStyle(),
							(b.input = b.el.getByTag('input')),
							(b.inputContainer = b.el.select('.' + n)),
							(b.drop = b.el.select('.' + m)),
							b.leftTpl &&
								((b.left = b.el.select('.' + o)),
								b.left.css({ display: 'block', width: b.leftWidth })),
							b.setSize(),
							c.appendChild(d.dom),
							'top' === b.labelAlign
								? b.el.addCls(p)
								: 'right' === b.labelAlign &&
								  ...
								  a
										.$(d.dom)
										.find('.' + g)
										.insertAfter(a.$(d.dom).find('.' + h))),
							b.valueIndex && (b.acceptedValue = b.value),
							b.editable
								? b.input.css('cursor', 'auto')
								: b.input && b.input.attr('tabIndex', -1),
							b.disabled &&
								(b.addCls(l),
								b.input && b.input.attr('tabIndex', -1)),
					...
					renderList: function () {
						...
						b.selectAllText &&
							e.push(
								'<div class="fancy-combo-list-select-all"><div class="fancy-field-checkbox-input" style=""></div><span class="fancy-combo-list-select-all-text">' +
									b.selectAllText +
									'</span></div>'
							),
							!1 === b.editable &&
								...
								'checkbox' !== b.type &&
								e.push(
									'<div class="fancy-combo-list-sub-search-container"></div>'
								),
							b.list && b.list.destroy(),
							e.push(['<ul style="position: relative;">']),
							a.each(b.data, function (c, d) {
								var f = '',
									g = c[b.displayKey],
									h = c[b.valueKey];
								if (
									(String(b.value).toLocaleLowerCase() ===
										String(h).toLocaleLowerCase() &&
										(f = b.selectedItemCls),
									'' === g || ' ' === g)
								)
									g = '&nbsp;';
							...
							!1 === b.editable &&
								'checkbox' !== b.type &&
								!1 !== b.subSearch &&
								((b.subSearchField = new a.StringField({
									renderTo: b.list
										.select('.fancy-combo-list-sub-search-container')
										.item(0).dom,
									label: !1,
									style: { padding: '2px 2px 0px 2px' },
									events: [{ change: b.onSubSearchChange, scope: b }],
								})),
								b.subSearchField.setInputSize({
									width: b.getListWidth() - 6,
									height: 25,
								}),
								b.subSearchField.input.on(
									'keydown',
									b.onSubSearchKeyDown,
									b
								)),
							b.applyTheme();
					},
					getListWidth: function () {
						...
						return (
							b.input &&
								((a = b.input.parent().parent()), (c = a.width())),
							d && d > c && (c = d),
							c
						);
					},
						...
						return (
							a.each(b.data, function (a) {
								...
								e && (e = e.replace(/\(/g, '').replace(/\)/, '')),
									new RegExp('^' + e).test(
										a[b.displayKey].toLocaleLowerCase()
									) && d.push(a);
							}),
							b.data.length === d.length && (d = []),
							(b.aheadData = d),
							d
						);
					},
					renderAheadList: function () {
						...
						d.getDisplayValue();
						d.aheadList
							? (d.aheadList.firstChild().destroy(),
							  (b = d.aheadList),
							  (f = !0))
							: (b = a.get(document.createElement('div'))),
							a.each(d.aheadData, function (b, c) {
								var f = '',
									g = b[d.displayKey],
									h = b[d.valueKey];
								if (
									(0 === c && (f = d.selectedItemCls),
									'' === g || ' ' === g)
								)
									g = '&nbsp;';
								else if (d.listItemTpl) {
							...
							b.css({
								...
								left: '0px',
								top: '0px',
								width: d.getListWidth(),
							}),
							b.css({
								'max-height': d.listRowHeight * d.maxListRows + 'px',
								overflow: 'auto',
							}),
							!1 === f &&
								(b.addClass(a.cls, c),
					...
					clearListActive: function () {
						var a = this,
							b = a.selectedItemCls,
							c = a.focusedItemCls;
						a.list.select('.' + c).removeCls(c),
							a.list.select('.' + b).removeCls(b);
					},
					clearFocused: function () {
						var a = this,
							b = a.focusedItemCls;
						a.list && a.list.select('.' + b).removeCls(b),
							a.aheadList && a.aheadList.select('.' + b).removeCls(b);
					},
					onInput: function () {
						var a = this,
							b = a.getValue(),
					...
					getValueKey: function (a, b) {
						for (var c = this, d = 0, e = c.data.length; d < e; d++)
							if (
								String(
									c.data[d][c.displayKey]
								).toLocaleLowerCase() ===
								String(a).toLocaleLowerCase()
							)
								return b ? d : c.data[d][c.valueKey];
					},
					get: function () {
						return this.getValue();
					},
					getValue: function () {
						...
						return a.multiSelect
							? a.values
							: -1 === a.value || void 0 === a.value
							? -1 === a.value && a.input.dom.value
								? a.input.dom.value
								: ''
							: (a.valueKey, a.value);
					},
					size: function (a) {
						...
						'top' !== b.labelAlign && (b.inputHeight = d),
							...
							b.calcSize(),
							'top' === b.labelAlign
								? b.css({ height: 1.5 * b.height, width: b.width })
								: b.css({ height: b.height, width: b.width });
						var h = b.inputWidth,
							i = 2;
						'dark' === b.theme && (i = 0);
						var j = h - i;
						b.left && (j -= b.leftWidth),
							e.css({
								width: j,
								height: b.inputHeight,
								'margin-left': b.left ? b.leftWidth : 0,
							}),
							f.css({ width: h, height: b.inputHeight }),
					...
					onEnter: function (a, b) {
						...
						if (d.multiSelect) {
							...
							var h = e.select('.' + f);
							(h && h.dom) || (h = e.select('.' + g)),
								(c = h.attr('value')),
								d.set(c);
						} else if ('' === d.input.dom.value)
							d.set(d.input.dom.value);
						else {
					...
					onUp: function (a, b) {
						var c = this,
							...
							f = c.selectedItemCls;
						if (d) {
							(d = c.getActiveList().select('ul')),
								b.preventDefault();
							var g = d.select('.' + e),
								h = !1;
							g.dom || (g = d.select('.' + f)),
								g.dom || ((h = !0), (g = d.lastChild())),
								g.length > 1 && (g = g.item(0));
							var i = g.index(),
								j = d.select('li'),
							...
							m - d.dom.scrollTop > k
								? (d.dom.scrollTop = 1e4)
								: m - d.dom.scrollTop < 0 && (d.dom.scrollTop = m),
								c.clearFocused(),
								l.addClass(e);
						}
					},
					onDown: function (a, b) {
						...
						if (d) {
							...
							var g = d.select('.' + e),
								h = !1;
							g.dom || (g = d.select('.' + f)),
								g.dom || ((h = !0), (g = d.firstChild())),
								g.length > 1 && (g = g.item(0));
							var i = parseInt(g.css('height')),
								j = g.index(),
								k = d.select('li'),
								l = parseInt(d.css('height'));
							j === k.length - 1 || h ? (j = 0) : j++;
							var m = k.item(j),
								n = m.dom.offsetTop,
								o = parseInt(m.css('height'));
							n - d.dom.scrollTop < 0
								? (d.dom.scrollTop = 0)
								: n + o + 3 - d.dom.scrollTop > l &&
								  (d.dom.scrollTop = n - l + i + o),
								c.clearFocused(),
								m.addClass(e);
						} else c.showList();
					},
					...
					getActiveList: function () {
						var a = this,
							b = !1;
						return (
							a.list && 'none' !== a.list.css('display')
								? (b = a.list)
								: a.aheadList &&
								  'none' !== a.aheadList.css('display') &&
								  (b = a.aheadList),
							b
						);
					},
					getTypeActiveList: function () {
						var a = this;
						return a.list && 'none' !== a.list.css('display')
							? 'list'
							: a.aheadList && 'none' !== a.aheadList.css('display')
							? 'ahead'
							: void 0;
					},
					initMultiSelect: function () {
						var b = this,
							c = b.value;
						(b.values = []),
							(b.valuesIndex = new a.Collection()),
							void 0 !== b.value &&
								null !== c &&
								'' !== c &&
								(a.isArray(c)
									? ((b.values = c), (b.value = c[0]))
									: (b.values = [b.value]),
								a.each(b.values, function (a) {
									b.valuesIndex.add(b.getIndex(a), a);
								}));
					},
					getIndex: function (a) {
						for (
							var b = this, c = b.data, d = 0, e = c.length, f = -1;
							d < e;
							d++
						)
							if (
								String(c[d][b.valueKey]).toLocaleLowerCase() ==
								String(a).toLocaleLowerCase()
							)
								return d;
						return f;
					...
					setData: function (b) {
						...
						(c.data = b),
							c.multiSelect &&
								((c.values = []),
								(c.valuesIndex = new a.Collection()),
								c.clearListActive()),
							c.clear(),
							c.renderList(),
							c.onsList();
					...
					onSelectAllClick: function () {
						var a = this,
							...
							c = a.list
								.select('.fancy-combo-list-select-all')
								.item(0),
							d = c.hasClass('fancy-combo-item-selected');
						setTimeout(function () {
							d
								? c.removeCls('fancy-combo-item-selected')
								: c.addCls('fancy-combo-item-selected');
						}, 100),
							b.each(function (a, b) {
								d
									? a.hasClass('fancy-combo-item-selected') &&
									  a.dom.click()
									: a.hasClass('fancy-combo-item-selected') ||
									  a.dom.click();
							});
					...
					onSubSearchChange: function (b, c) {
						...
						(c = c.toLocaleLowerCase()),
							a.each(d.data, function (a, b) {
								new RegExp('^' + c).test(
									a[d.displayKey].toLocaleLowerCase()
								)
									? (e.item(b).css('display', 'block'),
									  (f += parseInt(e.item(b).css('height'))))
									: e.item(b).css('display', 'none');
							});
					...
					isListInsideViewBox: function (b) {
						var c = this,
							d = b.$dom.offset(),
							e = c.calcListHeight() + b.$dom.height();
						return !(
							d.top + e >
							a.getViewSize()[0] + Fancy.getScroll()[0]
						);
					},
					calcListHeight: function () {
						var a = this,
							b = a.data.length * a.listRowHeight;
						return (
							a.data.length > a.maxListRows &&
								(b = a.maxListRows * a.listRowHeight),
							b
						);
					},
					detectedNewValue: function (b) {
						var c = this;
						c.data.push({ text: b, value: b }),
							c.multiSelect &&
								((c.values = []),
								(c.valuesIndex = new a.Collection()),
								c.clearListActive()),
		...
		Fancy.define(
			['Fancy.form.field.SegButton', 'Fancy.SegButtonField'],
			{
				mixins: [Fancy.form.field.Mixin],
				extend: Fancy.Widget,
				type: 'field.button',
				...
				get: function () {
					var a = this,
						b = [];
					return (
						Fancy.each(a.items, function (a, c) {
				...
				clear: function (a) {
					this.allowToggle &&
						Fancy.each(this.items, function (b) {
							b.setPressed(!1, a);
						});
				},
				setValue: function (a) {
			...
			a.define(['Fancy.form.field.Radio', 'Fancy.Radio'], {
				...
				init: function () {
					...
					b.addEvents(
						...
						b.Super('init', arguments);
					var c = '';
					b.column &&
						((b.cls += ' ' + e),
						(c +=
							'<div style="margin-left: ' + b.labelWidth + 'px;">')),
						a.each(b.items, function (a, d) {
							var e = '',
								i = f;
							b.column || 0 === d || (e = 'margin-left:10px;'),
								a.value === b.value && (i += ' ' + g),
								(c += [
									'<div class="' + i + '" value=' + a.value + '>',
									'<div class="' +
										h +
										'" style="float:left;' +
										e +
				...
				ons: function () {
					...
					c.$dom.delegate('.' + f, 'click', function () {
						...
						c.on('mouseenter', b.onMouseOver, b),
						c.on('mouseleave', b.onMouseOut, b),
						b.tip && c.on('mousemove', b.onMouseMove, b);
				},
				onClick: function () {
					var a = this,
						b = a.checkedCls;
				...
				set: function (a, b) {
					var c = this,
						d = c.el,
						e = c.checkedCls;
					d.select('.' + f).removeCls(e),
						d.select('[value=' + a + ']').addCls(e),
						(c.value = a),
						!1 !== b && c.fire('change', c.value);
				},
				setValue: function (a, b) {
					this.set(a, b);
				},
				...
				calcColumns: function () {
					...
					'top' !== b.labelAlign &&
						b.label &&
						((d -= b.labelWidth), (d -= 20)),
						a.Array.each(b.items, function (a) {
							a.text.length > c && (c = a.text.length);
						});
					var e = Math.floor(d / (7 * c + 30));
					b.columns && b.columns <= e
						? (e = b.columns)
						: (b.columns = e),
						(b.columnWidth = Math.ceil(d / e)),
						(b.rows = Math.ceil(b.items.length / e));
				},
				setColumnsStyle: function () {
					...
					if (a.columns && 1 !== a.rows) {
						...
						b.each(function (b, d) {
							d % a.columns == 0 &&
								c.item(d).css('margin-left', '0px'),
								b.css('width', a.columnWidth);
						});
					}
				},
			});
				...
				(Fancy.isValid = function (a, b) {
					...
					if (
						(Fancy.isString(a)
							...
							: Fancy.isObject(a) &&
							  (a.type
									? ((c = Fancy.vtypes[a.type]), Fancy.applyIf(a, c))
									: (c = a)),
						c.before)
					) {
						var d = c.before,
						...
						Fancy.isString(d)
							? e.push(d)
							: Fancy.isArray(d) && (e = e.concat(d)),
							e.reverse();
						for (var f = 0, g = e.length; f < g; f++)
							if (
								((c = Fancy.isObject(e[f])
									? e[f]
									: Fancy.vtypes[e[f]]),
								c.re)
							) {
		...
		Fancy.Mixin('Fancy.grid.mixin.Edit', {
			remove: function (a, b, c) {
				...
				if ((b && (f = 'removeAt'), Fancy.isArray(a)))
					for (var g = 0, h = a.length; g < h; g++) e[f](a[g], c);
				else e[f](a);
				!1 !== c && d.setSidesHeight(),
					clearInterval(d.removeInt),
					(d.removeInt = setTimeout(function () {
			...
			removeAll: function () {
				...
				a.store.removeAll(),
					a.update(),
					a.scroller.update(),
					a.paging && a.paging.updateBar(),
					a.isGroupable() && a.grouping.reGroup();
			},
			add: function (a) {
				var b = this;
				if (!b.store)
				...
				if (Fancy.isArray(a))
					...
					b.store.add(a),
						b.setSidesHeight(),
						clearInterval(b.addInt),
						(b.addInt = setTimeout(function () {
			...
			insert: function (a, b, c) {
				...
				if (Fancy.isArray(b)) {
					if (b.length) {
						var g = b[0],
							h = Fancy.Object.keys(g);
						f.addField(h);
					}
					for (d = b.length - 1; -1 !== d; d--) e.insert(b[d], a, c);
					return void (!1 !== c && e.setSidesHeight());
				}
				if (Fancy.isArray(a)) {
					if (a.length) {
						var g = a[0],
				...
				if (Fancy.isObject(a) && void 0 === b)
					f.addField(Fancy.Object.keys(a)), (b = a), (a = 0);
				...
				e.paging &&
					'server' !== f.pageType &&
					(a += f.showPage * f.pageSize),
					f.insert(a, b, c),
					!1 !== c && e.setSidesHeight(),
					clearInterval(e.addInt),
					(e.addInt = setTimeout(function () {
			...
			setById: function (a, b, c) {
				...
				if (Fancy.isObject(b) && void 0 === c)
					for (var g in b) {
						...
						e.setItemData(f, b, c, a),
							-1 === f && e.getById(a).set(b);
					}
			...
			undoAll: function () {
				for (
					var a = this, b = a.store, c = 0, d = b.undoActions.length;
					c < d;
					c++
				)
					a.undo();
			...
			editCell: function (a) {
				var b = this,
					c = b.getSideByCell(a),
					d = Number(a.attr('index')),
					e = Number(a.parent().attr('index')),
					f = { side: c, rowIndex: d, columnIndex: e },
					g = b.getColumns(f.side);
				if (
					((f.column = g[f.columnIndex]), !0 === f.column.editable)
				) {
					...
					(f.item = h),
						(f.data = h.data),
						f.column.smartIndexFn
							? (f.value = f.column.smartIndexFn(f.data))
							: (f.value = b.store.get(f.rowIndex, f.column.index)),
						b.celledit.edit(f);
				}
			},
			getCell: function (a) {
				...
				if (void 0 !== a.id && void 0 !== a.index) {
					var f = e.getColumnOrderByKey(a.index),
						g = f.order,
						h = e.getRowById(a.id);
					if (
						((b = f.side),
				...
				if (void 0 !== a.rowIndex && void 0 !== a.columnIndex) {
					if (
						((b = a.side || 'center'),
						(c = e.getBody(b)),
						(d = c.getCell(a.rowIndex, a.columnIndex)),
						d.dom ||
							(d = e
								.getBody('center')
								.getCell(a.rowIndex, a.columnIndex)),
						d.dom ||
							(d = e
								.getBody('left')
								.getCell(a.rowIndex, a.columnIndex)),
		...
		Fancy.define(['Fancy.Grid', 'FancyGrid'], {
			...
			nativeResizeObserver: !1,
			dropOutSideActions: !0,
			constructor: function (a, b) {
				var c = this;
				Fancy.isDom(a) ? ((b = b || {}), (b.renderTo = a)) : (b = a),
					(b = b || {});
						...
						? (a.initStore(),
						  ...
						  void setTimeout(function () {
								(a.inited = !0),
									a.fire('init'),
									a.setBodysHeight(),
									a.state || a._setColumnsAutoWidth();
						  }, 100))
						: void (a.intWaitForStyle = setInterval(function () {
								Fancy.stylesLoaded &&
									(clearInterval(a.intWaitForStyle), a.init());
						  }, 100))
				);
			},
			loadModules: function () {
				...
				(Fancy.modules = Fancy.modules || {}),
					...
					a.summary &&
						((b.summary = !0), a.summary.options && (b.menu = !0)),
					a.exporter && ((b.exporter = !0), (b.excel = !0)),
					a.paging && (b.paging = !0),
					(a.filter || a.searching) && (b.filter = !0),
					a.data && a.data.proxy && (b.edit = !0),
					a.clicksToEdit && (b.edit = !0),
					a.defaults && a.defaults.editable && (b.edit = !0),
					(a.stateful || a.state) && (b.state = !0),
					Fancy.isObject(a.data) &&
						(a.data.proxy &&
							((b['server-data'] = !0),
					...
					(a.trackOver ||
						...
						a.selection) &&
						(b.selection = !0),
					a.contextmenu && (b.menu = !0),
					a.infinite && (b.infinite = !0);
				var f = function (a) {
				...
				Fancy.each(a.events, function (a) {
					...
					Fancy.each(a.tbar, f),
					Fancy.each(a.bbar, f),
					Fancy.each(a.buttons, f),
					Fancy.each(a.subTBar, f);
				var g = c.concat(d).concat(e);
				Fancy.each(g, function (c) {
					switch (
						(!0 === c.draggable && (b['column-drag'] = !0),
						!0 === c.sortable && (b.sort = !0),
						!0 === c.editable && (b.edit = !0),
						c.menu && (b.menu = !0),
						c.filter && (b.filter = !0),
						c.type)
					) {
					...
					Fancy.isArray(a.tbar) &&
						Fancy.each(a.tbar, function (a) {
							switch (a.action) {
								case 'add':
								case 'remove':
									b.edit = !0;
					...
					a.gridToGrid && (b.dd = !0),
					a.rowDragDrop && (b.dd = !0),
					(a.neededModules = { length: 0 });
				for (var h in b)
					void 0 === Fancy.modules[h] &&
						((a.neededModules[h] = !0), a.neededModules.length++);
				if (0 === a.neededModules.length)
					return (a.neededModules = !0), void a.init();
				var i = function (b) {
					delete a.neededModules[b],
						0 === --a.neededModules.length &&
							((a.neededModules = !0), a.init());
				};
				if (a.neededModules.dom)
					Fancy.loadModule('dom', function (b) {
						if (
							(delete a.neededModules[b],
							0 === --a.neededModules.length)
						)
							...
							for (var c in a.neededModules)
								'length' !== c && Fancy.loadModule(c, i);
					});
				else
					for (var h in a.neededModules)
						'length' !== h && Fancy.loadModule(h, i);
			},
			lockColumn: function (a, b) {
				var c = this;
				if (1 === c.columns.length) return !1;
				Fancy.isString(a) &&
					Fancy.each(c.columns, function (b, c) {
						if (b.index === a) return (a = c), !0;
					});
				var d = c.removeColumn(a, b);
				c.insertColumn(d, c.leftColumns.length, 'left'),
					c.header &&
						(c.leftHeader.reSetCheckBoxes(),
						c.groupheader &&
							(c.header.fixGroupHeaderSizing(),
							c.leftHeader.fixGroupHeaderSizing())),
					c.body.reSetIndexes(),
					c.leftBody.reSetIndexes(),
					c.fire('lockcolumn', { column: d }),
					c.update();
			},
			rightLockColumn: function (a, b) {
				...
				c.insertColumn(d, 0, 'right'),
					c.header &&
						(c.rightHeader.reSetCheckBoxes(),
						c.groupheader &&
							(c.header.fixGroupHeaderSizing(),
							c.rightHeader.fixGroupHeaderSizing())),
					c.body.reSetIndexes(),
					c.rightBody.reSetIndexes(),
					c.fire('rightlockcolumn', { column: d }),
					c.update();
			},
			unLockColumn: function (a, b) {
				...
				switch (
					(void 0 === b &&
						(Fancy.isString(a)
							? (Fancy.each(d.leftColumns, function (c, d) {
									if (c.index === a) return (b = 'left'), (a = d), !0;
							  }),
							  void 0 === b &&
									Fancy.each(d.rightColumns, function (c, d) {
										if (c.index === a)
											return (b = 'right'), (a = d), !0;
									}))
							: (b = 'left')),
					b)
				) {
					case 'left':
						Fancy.isString(a) &&
							Fancy.each(d.leftColumns, function (b, c) {
								if (b.index === a) return (a = c), !0;
							}),
							(c = d.removeColumn(a, b)),
							d.insertColumn(c, 0, 'center', 'left'),
							0 === d.leftColumns.length &&
								(d.leftEl.addCls(Fancy.GRID_LEFT_EMPTY_CLS),
								d.centerEl.css('left', '0px'));
						break;
					case 'right':
						if (
							(Fancy.isString(a) &&
								Fancy.each(d.rightColumns, function (b, c) {
									if (b.index === a) return (a = c), !0;
								}),
							(c = d.removeColumn(a, b)),
							d.insertColumn(c, d.columns.length, 'center', 'right'),
							0 === d.rightColumns.length)
						) {
				...
				'left' === b &&
					d.isGroupable() &&
					0 === d.leftColumns.length &&
					d.grouping.insertGroupEls(),
					d.header &&
						d.groupheader &&
						(d.header.fixGroupHeaderSizing(),
						d.rightHeader && d.rightHeader.fixGroupHeaderSizing(),
						d.leftHeader && d.leftHeader.fixGroupHeaderSizing()),
					d.body.reSetIndexes(),
					d.leftBody.reSetIndexes(),
					d.rightBody.reSetIndexes(),
					d.fire('unlockcolumn', { column: c });
			},
			moveColumn: function (a, b, c, d, e) {
				...
				if (e) {
					for (
						var h = 0,
							...
							j = e.cell.attr('index'),
							k = g.getHeader(b),
							l = e.cell.dom.outerHTML;
						h < i;
						h++
					)
						g.moveColumn(a, b, e.end - h, d);
				...
				if ('center' === a)
					switch (((f = g.removeColumn(c, 'center')), b)) {
						case 'left':
					...
					switch (((f = g.removeColumn(c, 'left')), b)) {
						case 'center':
					...
					switch (((f = g.removeColumn(c, 'right')), b)) {
						case 'center':
				...
				g.groupheader &&
					(g.header.fixGroupHeaderSizing(),
					g.leftColumns && g.leftHeader.fixGroupHeaderSizing(),
					g.rightColumns && g.rightHeader.fixGroupHeaderSizing()),
					g.getHeader(a).reSetCheckBoxes(),
					g.getHeader(b).reSetCheckBoxes(),
					g.update();
			},
			updateColumnsVisibility: function () {
				var a = this;
				a.columns &&
					(a.header && a.header.updateCellsVisibility(),
					a.body.updateColumnsVisibility()),
					a.leftColumns &&
						(a.leftHeader && a.leftHeader.updateCellsVisibility(),
						a.leftBody.updateColumnsVisibility()),
					a.rightColumns &&
						(a.rightHeader && a.rightHeader.updateCellsVisibility(),
						a.rightBody.updateColumnsVisibility());
			},
			...
			getColumnId: function (a) {
				var b = this;
				return (
					void 0 === b.columnsIdsSeed[a]
						? (b.columnsIdsSeed[a] = 0)
						: b.columnsIdsSeed[a]++,
					b.columnsIdsSeed[a] ? a + '-' + b.columnsIdsSeed[a] : a
				);
			},
			...
			_setColumnsAutoWidth: function () {
				...
				if (
					a.autoColumnWidth &&
					(!a.state ||
						Fancy.Object.isEmpty(a.state.getState()) ||
						a.allowAutoWidthStateIsEmpty) &&
					!a._firstTimeAutoColumnWidth
				) {
					var b = a.getColumns();
					Fancy.each(b, function (b) {
						b.autoWidth &&
							!b.hidden &&
							(b.index || b.smartIndexFn || b.render) &&
							a.autoSizeColumn(b.id, !0, b);
					}),
						setTimeout(function () {
							(a._firstTimeAutoColumnWidth = !0),
								delete a.allowAutoWidthStateIsEmpty;
						}, 1e3);
				}
			},
		}),
		...
		(function () {
			var a = Fancy;
			a.define('Fancy.grid.plugin.RowHeight', {
				extend: a.Plugin,
				ptype: 'grid.rowheight',
				inWidgetName: 'rowheight',
				cellTip: '{value}',
				stopped: !0,
				waitingForParentVisibility: !1,
				constructor: function () {
					this.Super('const', arguments),
						(this.rows = {}),
						(this.rowIndexes = []),
				...
				ons: function () {
					var a = this,
						b = a.widget;
					b.on('init', a.onInit, a),
						b.on('update', a.onUpdate, a),
				...
				onUpdate: function () {
					...
					a.each(d, function (d) {
						...
						(b.totalHeight = e),
						c.isGroupable() &&
							(b.totalHeight += c.grouping.getGroupRowsHeight()),
						setTimeout(function () {
							c.setSidesHeight(b.totalHeight),
								c.scroller.update(b.totalHeight);
						}, 50);
				},
				add: function (b, c, d) {
					var e = this;
					(e.rows[b] && e.rows[b] > c) ||
						((e.rows[b] = c),
						(e.rowIndexes[d] = c),
						clearInterval(e.intIndexesSum),
						(e.intIndexesSum = setTimeout(function () {
							(e.rowIndexesSum = []),
								a.each(e.rowIndexes, function (a, b) {
									e.rowIndexesSum[b] =
										0 === b ? a : e.rowIndexesSum[b - 1] + a;
								});
						}, 1)));
				},
				...
				waitToShow: function () {
					...
					if (!a.waitingForParentVisibility) {
						a.waitingForParentVisibility = !0;
						var b = a.widget,
							c = a.getHiddenParent(b.el);
						c &&
							(a.intWaitToShow = setInterval(function () {
								'none' !== c.css('display') &&
									(clearInterval(a.intWaitToShow),
									a.widget.update(),
									a.onUpdate());
							}, 350));
					}
				...
				getHiddenParent: function (a, b) {
					...
					if (!(++b > 10)) {
						...
						if ('body' !== a.dom.tagName.toLocaleLowerCase())
							return (a = a.parent()), this.getHiddenParent(a, b);
					}
				},
			});
		})(),
			...
			a.define('Fancy.grid.plugin.CellTip', {
				...
				ons: function () {
					var b = this,
						c = b.widget,
						d = a.get(document);
					c.on('cellenter', b.onCellEnter, b),
						c.on('cellleave', b.onCellLeave, b),
						d.on('touchend', b.onTouchEnd, b),
						d.on('mousemove', b.onDocMove, b);
				},
				onCellEnter: function (b, c) {
					...
					if (c && e.cellTip) {
						...
						(d.stopped = !1),
							a.apply(i, c.data),
							a.tip.update(h.getHTML(i)),
							a.tip.show(g.pageX + 15, g.pageY - 25);
					}
				},
				...
				onDocMove: function (e) {
					if (!0 !== this.stopped) {
						var f = this,
							g = f.widget;
						if (
							'none' === g.el.css('display') ||
							(g.panel &&
								g.panel.el &&
								'none' === g.panel.el.css('display'))
						)
							return (f.stopped = !0), void a.tip.hide(b);
						var h = a.get(e.target);
						return 'body' === h.prop('tagName').toLocaleLowerCase()
							? ((f.stopped = !0), void a.tip.hide(b))
							: h.hasClass(c) ||
							  h.hasClass(d) ||
							  !1 !== g.el.within(h)
							? void a.tip.show(e.pageX + 15, e.pageY - 25)
							: ((f.stopped = !0), void a.tip.hide(b));
					}
				},
			});
		...
		(function () {
			var a = Fancy,
				...
				c = a.TOOLTIP_CLS,
				d = a.TOOLTIP_INNER_CLS;
			a.define('Fancy.grid.plugin.HeaderCellTip', {
				extend: a.Plugin,
				...
				ons: function () {
					var b = this,
						c = b.widget,
						d = a.get(document);
					c.on('headercellenter', b.onCellEnter, b),
						c.on('headercellleave', b.onCellLeave, b),
						d.on('touchend', b.onTouchEnd, b),
						d.on('mousemove', b.onDocMove, b);
				},
				onCellEnter: function (b, c) {
					...
					if (e.headerCellTip) {
						...
						if (a.isString(e.headerCellTip)) f = e.headerCellTip;
						else if (
							a.isFunction(e.headerCellTip) &&
							((c.data = h), !1 === (f = e.headerCellTip(c)))
						)
							return;
						var i = new a.Template(f);
						(d.stopped = !1),
							a.apply(h, c.data),
							a.tip.update(i.getHTML(h)),
							a.tip.show(g.pageX + 15, g.pageY - 25);
					}
				},
				onCellLeave: function () {
			...
			a.define('Fancy.ToolTip', {
				...
				render: function () {
					var b = this,
						c = a.get(b.renderTo || document.body).dom,
						d = a.get(document.createElement('div'));
					d.addCls(a.cls, b.widgetCls, b.cls, b.extraCls),
						d.update(b.tpl.getHTML({ text: b.text })),
